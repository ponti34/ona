...
(lib.bg = function() {
	this.initialize(img._418_2_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,892,1088);


(lib.bg_blur = function() {
	this.initialize(img._418_2_bg_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,892,1088);


(lib.ch_base = function() {
	this.initialize(img._418_2_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,892,1088);


(lib.ch_base2 = function() {
	this.initialize(img._418_2_ch_base2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,892,1088);


(lib.ch_face10 = function() {
	this.initialize(img._418_2_ch_face10);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face2 = function() {
	this.initialize(img._418_2_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face3 = function() {
	this.initialize(img._418_2_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face4 = function() {
	this.initialize(img._418_2_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face5 = function() {
	this.initialize(img._418_2_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face6 = function() {
	this.initialize(img._418_2_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face7 = function() {
	this.initialize(img._418_2_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face8 = function() {
	this.initialize(img._418_2_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face9 = function() {
	this.initialize(img._418_2_ch_face9);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.finish = function() {
	this.initialize(img._418_2_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._418_2_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._418_2_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._418_2_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,446,544), null);
...
(lib.bg_zoom_half3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(0,0,446,544);
...
(lib.bg_zoom_half2 = function(mode,startPosition,loop) {
	...
	// bg_image
	this.instance = new lib.ch_base2();
	this.instance.parent = this;
	this.instance.setTransform(0,0,0.5,0.5);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AgiA1QAKgIAGgMQAFgMACgRQABgPAAgUIAAgFIAOAAIAAATIgBAQQAHgGAFgMQAFgMABgSIgKAAIgMAAIgMAAIgLAAIgHAAIAAgQIAEAAIANAAIAOAAIAQAAIANAAIAGAAQAAAVgDAQQgEAQgFAKQgGAJgGAGIgIgLQgCAPgCALQgDAMgGAJQgFAKgJAHg");
	this.shape.setTransform(64.8,0.925);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AgZA4QAQgFAIgKQAHgJADgNQADgNAAgMIAAgLIAAgMIAAgQIAAgOIAAgKIAPAAIAAAFIAAAMIAAARIAAARIAAAOQAAAQgEAMQgDANgGAJQgGAJgIAGQgGAGgIADgAgaAPIAAhUIAPAAIAABUg");
	this.shape_1.setTransform(56.925,0.625);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("AghA5IAAgRIAaAAIAAhQIgWAAIAAgQIA8AAIAAAQIgYAAIAABQIAbAAIAAARg");
	this.shape_2.setTransform(48.85,0.625);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("AgdA8QAMgGAJgKQAIgKAFgMIgHgNIgJgKIAHgMIAHAJIAIALQAFgNADgLIACgTIgVAAIgKAZQgGALgIALIgKgKQADgDAGgJQAFgKAFgOQAFgPAEgVIAMACIgCAKIgBAJIAhAAQgCARgDASQgDARgGAQQgHARgKAOQgIAOgPAJg");
	this.shape_3.setTransform(40.7,0.425);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("AgjAwQALgHAHgKQAIgLAFgNQAFgLADgOIAFgbIgiABIAAgRIAyAAQgCATgDAQQgDAPgEAMIAIAOIAIAQIAHAQIgLAOQgFgNgEgLIgJgTQgHARgJALQgIAKgJAGg");
	this.shape_4.setTransform(32.8,0.875);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#333333").s().p("AgcA2QAPgDAKgKQAIgKAGgOQAEgOABgQIgNAAIgPABIgMAAIgHAAIAAgQIA+AAQAAApgNAYQgNAYgWAIgAgYg0IAAgPIAxgBIAAAQg");
	this.shape_5.setTransform(24.95,0.825);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("AgeAxQASgIAJgOQAJgPAEgSQAFgTABgWIgLAAIgLABIgMAAIgJAAIgDAAIAAgRIA9AAQAAAzgNAfQgMAggZANg");
	this.shape_6.setTransform(16.925,0.875);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("AgKALQgEgFAAgGQAAgFAEgFQAEgEAGAAQAGAAAEAEQAEAFABAFQgBAGgEAFQgEAEgGAAQgGAAgEgEg");
	this.shape_7.setTransform(8.85,0.425);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#333333").s().p("");
	this.shape_8.setTransform(-3.125,0.65);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#333333").s().p("");
	this.shape_9.setTransform(-19.15,0.375);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#333333").s().p("AgyBAIAAh+IBjAAIAAARIhRAAIAAAkIBJAAIAAAPIhJAAIAAApIBTAAIAAARg");
	this.shape_10.setTransform(-32.775,0.4);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#333333").s().p("AgLBAIg0h+IAVAAIAaBAIAQArIARgrIAahAIAVAAIg0B+g");
	this.shape_11.setTransform(-45.925,0.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#333333").s().p("AgJBAIAAh+IASAAIAAB+g");
	this.shape_12.setTransform(-54.85,0.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#333333").s().p("AgxA/IAAh+IASAAIAABuIBRAAIAAARg");
	this.shape_13.setTransform(-62.55,0.425);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(92.8,62.7,1.4337,0.5716,0,-51.8975,-52.1431,0.1,0.1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(10).to({_off:false},0).to({_off:true},2).wait(8));

	// moisture_righteye
	this.instance_1 = new lib.uru_set();
	this.instance_1.parent = this;
	this.instance_1.setTransform(35.5,83.85,1.4048,0.6167,0,112.0333,116.5912,0.7,4);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(10).to({_off:false},0).to({_off:true},2).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).wait(8));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-57,269);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.face_blink_ary = [1, 1, 1, 0, 0, 0, 1, 0, 0, 0, 0, 0, 1, 1, 1]; 
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:70.8711,y:73.2714}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
...
p.nominalBounds = new cjs.Rectangle(-177,-127,446,544);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-177.95,-87);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-298,-483,608.2,614.7);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:-75,regY:-211,x:-75,y:-219.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-220.2},0).wait(1).to({y:-217.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-216.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-216.75},0).wait(1).to({y:-209.8},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-207.75},0).wait(1).to({y:-210.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-215.95},0).wait(1).to({y:-210.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-215.95},0).wait(1).to({y:-210.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-210.1},0).wait(1).to({y:-210.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-220},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-223.95},0).wait(1).to({y:-220.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-209},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-211.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-220},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-223.95},0).wait(1).to({y:-220.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-209},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-211.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-75,regY:-211,x:-75,y:-210.4},0).wait(1).to({y:-208},0).wait(1).to({y:-205.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-205.65},0).wait(1).to({y:-208},0).wait(1).to({y:-210.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-75,regY:-211,x:-75,y:-210.85},0).wait(1).to({y:-210.3},0).wait(1).to({y:-209.2},0).wait(1).to({y:-207.85},0).wait(1).to({y:-206.75},0).wait(1).to({y:-206.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-206.2},0).wait(1).to({y:-206.75},0).wait(1).to({y:-207.85},0).wait(1).to({y:-209.2},0).wait(1).to({y:-210.3},0).wait(1).to({y:-210.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:-75,regY:-211,x:-75,y:-206.25},0).wait(1).to({y:-209.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:-75,regY:-211,x:-75,y:-208.8},0).wait(1).to({y:-210.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-75,regY:-211,rotation:-0.0253,x:-75.1,y:-210.9},0).wait(1).to({rotation:-0.1129,x:-75.3,y:-210.5},0).wait(1).to({rotation:-0.2845,x:-75.7,y:-209.75},0).wait(1).to({rotation:-0.5565,x:-76.35,y:-208.5},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-77.15,y:-206.95},0).wait(1).to({rotation:-1.2075,x:-77.9,y:-205.5},0).wait(1).to({rotation:-1.4141,x:-78.35,y:-204.5},0).wait(1).to({rotation:-1.5201,x:-78.6,y:-204},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(1).to({regX:-75,regY:-211,rotation:-1.5305,x:-78.65,y:-204},0).wait(1).to({rotation:-1.4624,x:-78.5,y:-204.3},0).wait(1).to({rotation:-1.3309,x:-78.15,y:-204.9},0).wait(1).to({rotation:-1.121,x:-77.75,y:-205.95},0).wait(1).to({rotation:-0.8372,x:-77.05,y:-207.2},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-76.3,y:-208.65},0).wait(1).to({rotation:-0.2881,x:-75.75,y:-209.75},0).wait(1).to({rotation:-0.1291,x:-75.35,y:-210.55},0).wait(1).to({rotation:-0.0467,x:-75.15,y:-210.9},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-75,regY:-211,rotation:-0.0253,x:-75.1,y:-210.9},0).wait(1).to({rotation:-0.1129,x:-75.3,y:-210.5},0).wait(1).to({rotation:-0.2845,x:-75.7,y:-209.75},0).wait(1).to({rotation:-0.5565,x:-76.35,y:-208.5},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-77.15,y:-206.95},0).wait(1).to({rotation:-1.2075,x:-77.9,y:-205.5},0).wait(1).to({rotation:-1.4141,x:-78.35,y:-204.5},0).wait(1).to({rotation:-1.5201,x:-78.6,y:-204},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(1).to({regX:-75,regY:-211,rotation:-1.5302,x:-78.65,y:-204},0).wait(1).to({rotation:-1.461,x:-78.5,y:-204.3},0).wait(1).to({rotation:-1.3276,x:-78.15,y:-204.9},0).wait(1).to({rotation:-1.1146,x:-77.7,y:-205.95},0).wait(1).to({rotation:-0.8266,x:-77,y:-207.2},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.5189,x:-76.25,y:-208.65},0).wait(1).to({rotation:-0.2693,x:-75.7,y:-209.8},0).wait(1).to({rotation:-0.1079,x:-75.3,y:-210.55},0).wait(1).to({rotation:-0.0243,x:-75.1,y:-210.9},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:-75,regY:-211,x:-75,y:-216.55},0).wait(1).to({y:-218.45},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-218.35},0).wait(1).to({y:-216.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:-75,regY:-211,x:-75,y:-219.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-220.2},0).wait(1).to({y:-217.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:-75,regY:-211,rotation:-0.0253,x:-75.1,y:-210.85},0).wait(1).to({rotation:-0.1129,x:-75.3,y:-210.2},0).wait(1).to({rotation:-0.2845,x:-75.7,y:-209},0).wait(1).to({rotation:-0.5565,x:-76.35,y:-207.05},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-77.15,y:-204.6},0).wait(1).to({rotation:-1.2075,x:-77.9,y:-202.35},0).wait(1).to({rotation:-1.4141,x:-78.35,y:-200.85},0).wait(1).to({rotation:-1.5201,x:-78.6,y:-200.1},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:9},0).wait(1).to({regX:-75,regY:-211,rotation:-1.5305,x:-78.65,y:-200.05},0).wait(1).to({rotation:-1.4624,x:-78.5,y:-200.55},0).wait(1).to({rotation:-1.3309,x:-78.15,y:-201.45},0).wait(1).to({rotation:-1.121,x:-77.75,y:-203.05},0).wait(1).to({rotation:-0.8372,x:-77.05,y:-205.1},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-76.3,y:-207.3},0).wait(1).to({rotation:-0.2881,x:-75.75,y:-209.05},0).wait(1).to({rotation:-0.1291,x:-75.35,y:-210.25},0).wait(1).to({rotation:-0.0467,x:-75.15,y:-210.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-75,regY:-211,rotation:-0.147,x:-75.4,y:-210.35},0).wait(1).to({rotation:-0.7239,x:-76.75,y:-207.7},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.3727,x:-78.25,y:-204.7},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(18).to({regX:-75,regY:-211,rotation:-1.4913,x:-78.55,y:-204.15},0).wait(1).to({rotation:-1.2701,x:-78,y:-205.2},0).wait(1).to({rotation:-0.8372,x:-77.05,y:-207.2},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:-75.95,y:-209.45},0).wait(1).to({rotation:-0.094,x:-75.3,y:-210.7},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-75,regY:-211,rotation:-0.0894,x:-75.25,y:-210.65},0).wait(1).to({rotation:-0.4358,x:-76.05,y:-209.05},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.0316,x:-77.5,y:-206.3},0).wait(1).to({rotation:-1.4426,x:-78.4,y:-204.35},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(8).to({regX:-75,regY:-211,rotation:-1.4913,x:-78.55,y:-204.15},0).wait(1).to({rotation:-1.2701,x:-78,y:-205.2},0).wait(1).to({rotation:-0.8372,x:-77.05,y:-207.2},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:-75.95,y:-209.45},0).wait(1).to({rotation:-0.094,x:-75.3,y:-210.7},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-219.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-220.2},0).wait(1).to({y:-217.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-75,regY:-211,x:-77.75,y:-203.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:-75,regY:-211,x:-75,y:-198.75},0).wait(1).to({y:-201.7},0).wait(1).to({y:-206.65},0).wait(1).to({y:-210.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-210},0).wait(1).to({y:-204.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:-75,regY:-211,x:-75,y:-203.2},0).wait(1).to({y:-207.5},0).wait(1).to({y:-211.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-211.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-75,regY:-211,x:-75,y:-217.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-217.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-219.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-220.2},0).wait(1).to({y:-217.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-75,regY:-211,x:-77.75,y:-203.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:-75,regY:-211,x:-75,y:-200.25},0).wait(1).to({y:-208},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-212},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-211.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-210.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-75,regY:-211,x:-75,y:-210.4},0).wait(1).to({y:-208},0).wait(1).to({y:-205.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-205.6},0).wait(1).to({y:-205.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:-75,regY:-211,x:-75,y:-206.4},0).wait(1).to({y:-207.9},0).wait(1).to({y:-210.15},0).wait(1).to({y:-211.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-211.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-218.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-220.2},0).wait(1).to({y:-217.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:-75,regY:-211,x:-75,y:-218.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:-75,regY:-211,x:-75,y:-219},0).wait(1).to({y:-213},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:-75,regY:-211,x:-75,y:-206.35},0).wait(1).to({y:-207.55},0).wait(1).to({y:-209.5},0).wait(1).to({y:-210.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-215.95},0).wait(1).to({y:-210.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-215.95},0).wait(1).to({y:-210.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-75,regY:-211,x:-75,y:-210.1},0).wait(1).to({y:-210.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-75,regY:-211,x:-72,y:-207.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:-75,regY:-211,x:-75.85,y:-201.55},0).wait(1).to({x:-75.2,y:-201.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:-75,regY:-211,x:-75,y:-201.7},0).wait(1).to({y:-204.15},0).wait(1).to({y:-207.85},0).wait(1).to({y:-210.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(10));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-456.9,-680.4,813.5,812.9);
...
// stage content:
(lib._418_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:166,scene2:167,end2:325,scene3:326,end3:479,scene4:480,end4:658,scene5:659,end5:840,scene6:841,end6:1001,scene7:1002,end7:1168});
	...
	this.frame_218 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "んですね!";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 2);
	}
	this.frame_265 = function() {
		exportRoot._g.m3 = "んですね! あっ､";
		exportRoot._u.setText();
	...
	this.frame_681 = function() {
		exportRoot._g.m1 = "お花､増えましたね｡";
		exportRoot._u.setText();
		this.ch2.gotoAndPlay("nod");
	}
	this.frame_708 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "もずっと｡";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 1);
		this.ch2.gotoAndPlay("swing");
	}
	this.frame_749 = function() {
		exportRoot._g.m2 = "もずっと｡その分､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 2);
		this.ch2.gotoAndPlay("nod");
	}
	...
	this.frame_874 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "日もありました｡";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 7);
	}
	this.frame_909 = function() {
		exportRoot._g.m2 = "日もありました｡でも､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 3);
	}
	...
	this.frame_1019 = function() {
		exportRoot._g.m1 = "私､幸せです｡";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 8);
	}
	this.frame_1043 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "らえて……｡";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 1);
	}
	this.frame_1087 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "に笑顔を……";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 2);
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(16).call(this.frame_31).wait(35).call(this.frame_66).wait(40).call(this.frame_106).wait(33).call(this.frame_139).wait(27).call(this.frame_166).wait(1).call(this.frame_167).wait(39).call(this.frame_206).wait(12).call(this.frame_218).wait(47).call(this.frame_265).wait(10).call(this.frame_275).wait(40).call(this.frame_315).wait(10).call(this.frame_325).wait(1).call(this.frame_326).wait(18).call(this.frame_344).wait(15).call(this.frame_359).wait(29).call(this.frame_388).wait(30).call(this.frame_418).wait(9).call(this.frame_427).wait(23).call(this.frame_450).wait(13).call(this.frame_463).wait(16).call(this.frame_479).wait(1).call(this.frame_480).wait(30).call(this.frame_510).wait(23).call(this.frame_533).wait(58).call(this.frame_591).wait(23).call(this.frame_614).wait(36).call(this.frame_650).wait(8).call(this.frame_658).wait(1).call(this.frame_659).wait(22).call(this.frame_681).wait(27).call(this.frame_708).wait(41).call(this.frame_749).wait(17).call(this.frame_766).wait(55).call(this.frame_821).wait(19).call(this.frame_840).wait(1).call(this.frame_841).wait(33).call(this.frame_874).wait(35).call(this.frame_909).wait(15).call(this.frame_924).wait(25).call(this.frame_949).wait(20).call(this.frame_969).wait(32).call(this.frame_1001).wait(1).call(this.frame_1002).wait(17).call(this.frame_1019).wait(24).call(this.frame_1043).wait(44).call(this.frame_1087).wait(38).call(this.frame_1125).wait(29).call(this.frame_1154).wait(14).call(this.frame_1168).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1173));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1168).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1173));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},6,cjs.Ease.get(1)).to({_off:true},1).wait(1151));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1158));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(15).to({alpha:0.1016},6).to({_off:true},1).wait(1151));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(1071).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1111).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1111).to({_off:false},0).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(1111).to({_off:false},0).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1099).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(15).to({_off:false},0).to({alpha:0},3).to({_off:true},1).wait(461).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(14).to({_off:false},0).to({alpha:1},5).wait(3).to({alpha:0},10).to({_off:true},1).wait(481).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11}]}).to({state:[]},15).wait(1158));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({_off:false},0).wait(597).to({regX:0,scaleX:1.1997,scaleY:1.1997,rotation:-4.2598,x:145.75,y:-12.2},35).wait(526));

	// book
	this.bg3 = new lib.bg_zoom_half2();
	this.bg3.name = "bg3";
	this.bg3.parent = this;
	this.bg3.setTransform(-30.55,-21.25,0.609,0.609,0,0,0,-0.1,0.1);
	this.bg3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg3).wait(480).to({_off:false},0).to({_off:true},27).wait(666));
	...
	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.3,regY:0.1,scaleX:0.6723,scaleY:0.6723,x:151.75,y:292.3},0).wait(17).to({regX:-49.2,regY:-274.9,scaleX:0.6722,scaleY:0.6722,x:118.45,y:107.4},0).wait(1).to({scaleX:0.6721,scaleY:0.6721,y:107.45},0).wait(1).to({scaleX:0.6719,scaleY:0.6719},0).wait(1).to({scaleX:0.6716,scaleY:0.6716},0).wait(1).to({scaleX:0.6711,scaleY:0.6711,y:107.5},0).wait(1).to({scaleX:0.6706,scaleY:0.6706},0).wait(1).to({scaleX:0.6699,scaleY:0.6699,y:107.55},0).wait(1).to({scaleX:0.669,scaleY:0.669,y:107.65},0).wait(1).to({scaleX:0.668,scaleY:0.668},0).wait(1).to({scaleX:0.6668,scaleY:0.6668,y:107.75},0).wait(1).to({scaleX:0.6654,scaleY:0.6654,x:118.4,y:107.85},0).wait(1).to({scaleX:0.6638,scaleY:0.6638,x:118.45,y:108},0).wait(1).to({scaleX:0.6619,scaleY:0.6619,y:108.1},0).wait(1).to({scaleX:0.6598,scaleY:0.6598,x:118.4,y:108.2},0).wait(1).to({scaleX:0.6574,scaleY:0.6574,y:108.35},0).wait(1).to({scaleX:0.6547,scaleY:0.6547,y:108.55},0).wait(1).to({scaleX:0.6517,scaleY:0.6517,y:108.7},0).wait(1).to({scaleX:0.6485,scaleY:0.6485,y:108.95},0).wait(1).to({scaleX:0.6451,scaleY:0.6451,x:118.35,y:109.1},0).wait(1).to({scaleX:0.6416,scaleY:0.6416,y:109.35},0).wait(1).to({scaleX:0.6381,scaleY:0.6381,y:109.6},0).wait(1).to({scaleX:0.6347,scaleY:0.6347,x:118.3,y:109.8},0).wait(1).to({scaleX:0.6316,scaleY:0.6316,y:110},0).wait(1).to({scaleX:0.6289,scaleY:0.6289,y:110.2},0).wait(1).to({scaleX:0.6264,scaleY:0.6264,x:118.35,y:110.3},0).wait(1).to({scaleX:0.6243,scaleY:0.6243,y:110.5},0).wait(1).to({scaleX:0.6225,scaleY:0.6225,x:118.3,y:110.55},0).wait(1).to({scaleX:0.6211,scaleY:0.6211,y:110.65},0).wait(1).to({scaleX:0.6198,scaleY:0.6198,y:110.75},0).wait(1).to({scaleX:0.6189,scaleY:0.6189,y:110.8},0).wait(1).to({scaleX:0.6182,scaleY:0.6182},0).wait(1).to({scaleX:0.6176,scaleY:0.6176,y:110.85},0).wait(1).to({scaleX:0.6172,scaleY:0.6172,y:110.9},0).wait(1).to({scaleX:0.617,scaleY:0.617,y:110.95},0).wait(1).to({regX:0.3,regY:0.1,x:148.9,y:280.6},0).wait(101).to({scaleX:0.6208,scaleY:0.6208,x:149.45,y:281.45,alpha:0},13,cjs.Ease.get(1)).to({_off:true},1).wait(992));
	...
	this.bg1_1 = new lib.bg_zoom_half3();
	this.bg1_1.name = "bg1_1";
	this.bg1_1.parent = this;
	this.bg1_1.setTransform(-48.75,-32.35,0.6723,0.6723,0,0,0,-0.1,0.1);
	this.bg1_1._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.bg1}]}).to({state:[{t:this.bg1_1}]},15).to({state:[{t:this.bg1_1}]},16).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[{t:this.bg1_1}]},1).to({state:[]},1).wait(1106));
	this.timeline.addTween(cjs.Tween.get(this.bg1_1).wait(15).to({_off:false},0).wait(17).to({regX:223,regY:272,scaleX:0.6722,scaleY:0.6722,x:101.25,y:150.5,alpha:0.9992},0).wait(1).to({scaleX:0.6721,scaleY:0.6721,y:150.45,alpha:0.9969},0).wait(1).to({scaleX:0.6719,scaleY:0.6719,y:150.5,alpha:0.9929},0).wait(1).to({scaleX:0.6716,scaleY:0.6716,y:150.45,alpha:0.9869},0).wait(1).to({scaleX:0.6711,scaleY:0.6711,y:150.5,alpha:0.9789},0).wait(1).to({scaleX:0.6706,scaleY:0.6706,x:101.3,alpha:0.9687},0).wait(1).to({scaleX:0.6699,scaleY:0.6699,alpha:0.9561},0).wait(1).to({scaleX:0.669,scaleY:0.669,x:101.35,y:150.45,alpha:0.9407},0).wait(1).to({scaleX:0.668,scaleY:0.668,y:150.5,alpha:0.9224},0).wait(1).to({scaleX:0.6668,scaleY:0.6668,y:150.45,alpha:0.9007},0).wait(1).to({scaleX:0.6654,scaleY:0.6654,x:101.4,y:150.5,alpha:0.8755},0).wait(1).to({scaleX:0.6638,scaleY:0.6638,y:150.45,alpha:0.8462},0).wait(1).to({scaleX:0.6619,scaleY:0.6619,x:101.45,alpha:0.8125},0).wait(1).to({scaleX:0.6598,scaleY:0.6598,x:101.55,alpha:0.7741},0).wait(1).to({scaleX:0.6574,scaleY:0.6574,alpha:0.7306},0).wait(1).to({scaleX:0.6547,scaleY:0.6547,x:101.65,y:150.4,alpha:0.6819},0).wait(1).to({scaleX:0.6517,scaleY:0.6517,x:101.7,alpha:0.628},0).wait(1).to({scaleX:0.6485,scaleY:0.6485,x:101.75,y:150.45,alpha:0.5697},0).wait(1).to({scaleX:0.6451,scaleY:0.6451,x:101.85,y:150.4,alpha:0.5079},0).wait(1).to({scaleX:0.6416,scaleY:0.6416,x:101.9,alpha:0.4444},0).wait(1).to({scaleX:0.6381,scaleY:0.6381,x:102,alpha:0.3814},0).wait(1).to({scaleX:0.6347,scaleY:0.6347,x:102.05,alpha:0.3211},0).wait(1).to({scaleX:0.6316,scaleY:0.6316,x:102.1,alpha:0.2651},0).wait(1).to({scaleX:0.6289,scaleY:0.6289,x:102.2,alpha:0.2148},0).wait(1).to({scaleX:0.6264,scaleY:0.6264,x:102.25,alpha:0.1706},0).wait(1).to({scaleX:0.6243,scaleY:0.6243,y:150.35,alpha:0.1326},0).wait(1).to({scaleX:0.6225,scaleY:0.6225,x:102.3,y:150.4,alpha:0.1004},0).wait(1).to({scaleX:0.6211,scaleY:0.6211,x:102.35,alpha:0.0737},0).wait(1).to({scaleX:0.6198,scaleY:0.6198,y:150.35,alpha:0.052},0).wait(1).to({scaleX:0.6189,scaleY:0.6189,x:102.4,y:150.4,alpha:0.0347},0).wait(1).to({scaleX:0.6182,scaleY:0.6182,alpha:0.0213},0).wait(1).to({scaleX:0.6176,scaleY:0.6176,y:150.35,alpha:0.0116},0).wait(1).to({scaleX:0.6172,scaleY:0.6172,x:102.45,alpha:0.0049},0).wait(1).to({scaleX:0.617,scaleY:0.617,y:150.4,alpha:0.0012},0).wait(1).to({regX:-0.1,regY:0.1,x:-35.15,y:-17.4,alpha:0},0).to({_off:true},1).wait(1106));

	// bg
	this.bg2 = new lib.bg_zoom_half();
	this.bg2.name = "bg2";
	this.bg2.parent = this;
	this.bg2.setTransform(-48.75,-32.35,0.6723,0.6723,0,0,0,-0.1,0.1);
	this.bg2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg2).wait(15).to({_off:false},0).wait(17).to({regX:223,regY:272,scaleX:0.6722,scaleY:0.6722,x:101.25,y:150.5},0).wait(1).to({scaleX:0.6721,scaleY:0.6721,y:150.45},0).wait(1).to({scaleX:0.6719,scaleY:0.6719,y:150.5},0).wait(1).to({scaleX:0.6716,scaleY:0.6716,y:150.45},0).wait(1).to({scaleX:0.6711,scaleY:0.6711,y:150.5},0).wait(1).to({scaleX:0.6706,scaleY:0.6706,x:101.3},0).wait(1).to({scaleX:0.6699,scaleY:0.6699},0).wait(1).to({scaleX:0.669,scaleY:0.669,x:101.35,y:150.45},0).wait(1).to({scaleX:0.668,scaleY:0.668,y:150.5},0).wait(1).to({scaleX:0.6668,scaleY:0.6668,y:150.45},0).wait(1).to({scaleX:0.6654,scaleY:0.6654,x:101.4,y:150.5},0).wait(1).to({scaleX:0.6638,scaleY:0.6638,y:150.45},0).wait(1).to({scaleX:0.6619,scaleY:0.6619,x:101.45},0).wait(1).to({scaleX:0.6598,scaleY:0.6598,x:101.55},0).wait(1).to({scaleX:0.6574,scaleY:0.6574},0).wait(1).to({scaleX:0.6547,scaleY:0.6547,x:101.65,y:150.4},0).wait(1).to({scaleX:0.6517,scaleY:0.6517,x:101.7},0).wait(1).to({scaleX:0.6485,scaleY:0.6485,x:101.75,y:150.45},0).wait(1).to({scaleX:0.6451,scaleY:0.6451,x:101.85,y:150.4},0).wait(1).to({scaleX:0.6416,scaleY:0.6416,x:101.9},0).wait(1).to({scaleX:0.6381,scaleY:0.6381,x:102},0).wait(1).to({scaleX:0.6347,scaleY:0.6347,x:102.05},0).wait(1).to({scaleX:0.6316,scaleY:0.6316,x:102.1},0).wait(1).to({scaleX:0.6289,scaleY:0.6289,x:102.2},0).wait(1).to({scaleX:0.6264,scaleY:0.6264,x:102.25},0).wait(1).to({scaleX:0.6243,scaleY:0.6243,y:150.35},0).wait(1).to({scaleX:0.6225,scaleY:0.6225,x:102.3,y:150.4},0).wait(1).to({scaleX:0.6211,scaleY:0.6211,x:102.35},0).wait(1).to({scaleX:0.6198,scaleY:0.6198,y:150.35},0).wait(1).to({scaleX:0.6189,scaleY:0.6189,x:102.4,y:150.4},0).wait(1).to({scaleX:0.6182,scaleY:0.6182},0).wait(1).to({scaleX:0.6176,scaleY:0.6176,y:150.35},0).wait(1).to({scaleX:0.6172,scaleY:0.6172,x:102.45},0).wait(1).to({scaleX:0.617,scaleY:0.617,y:150.4},0).wait(1).to({regX:-0.1,regY:0.1,x:-35.15,y:-17.4},0).wait(101).to({scaleX:0.6208,scaleY:0.6208,x:-35.75,y:-18.35,alpha:0},13,cjs.Ease.get(1)).to({_off:true},1).wait(992));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(-178,570,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(15).to({regX:0.3,regY:0.1,scaleX:0.6208,scaleY:0.6208,x:175.35,y:281.45,alpha:0},0).wait(152).to({scaleX:0.7715,scaleY:0.7715,x:169.25,y:325.3,alpha:1},0).to({x:189.25},17,cjs.Ease.quadInOut).wait(82).to({regX:-49.2,regY:-274.9,x:150.95,y:113.1},0).wait(1).to({x:150.75},0).wait(1).to({x:150.4},0).wait(1).to({x:149.8},0).wait(1).to({x:149.05},0).wait(1).to({x:148},0).wait(1).to({x:146.65},0).wait(1).to({x:144.95},0).wait(1).to({x:142.9},0).wait(1).to({x:140.4},0).wait(1).to({x:137.5},0).wait(1).to({x:134.45},0).wait(1).to({x:131.35},0).wait(1).to({x:128.6},0).wait(1).to({x:126.25},0).wait(1).to({x:124.45},0).wait(1).to({x:123.05},0).wait(1).to({x:122.1},0).wait(1).to({x:121.45},0).wait(1).to({x:121.15},0).wait(1).to({regX:0.3,regY:0.1,x:159.25,y:325.3},0).wait(221).to({scaleX:0.8917,scaleY:0.8917,x:167.25,y:370.65},0).wait(334).to({regX:0.4,regY:0.3,scaleX:0.9867,scaleY:0.9867,x:171.35,y:399.8},19,cjs.Ease.quadInOut).wait(142).to({regX:0.3,regY:0.1,scaleX:0.5988,scaleY:0.5988,x:153.25,y:276.8},0).to({_off:true},109).wait(62));

	// bg2
	this.bg2_1 = new lib.bg_zoom_half();
	this.bg2_1.name = "bg2_1";
	this.bg2_1.parent = this;
	this.bg2_1.setTransform(-1.95,-279.15,1.27,1.27);

	this.timeline.addTween(cjs.Tween.get(this.bg2_1).wait(15).to({regX:-0.1,regY:0.1,scaleX:0.5988,scaleY:0.5988,x:438.7,y:-12.4},0).wait(152).to({scaleX:0.7715,scaleY:0.7715,x:-85.9,y:-47.25},0).to({x:-65.9},17,cjs.Ease.quadInOut).wait(82).to({regX:223,regY:272,x:106.2,y:162.5},0).wait(1).to({x:106},0).wait(1).to({x:105.65},0).wait(1).to({x:105.1},0).wait(1).to({x:104.35},0).wait(1).to({x:103.35},0).wait(1).to({x:102.05},0).wait(1).to({x:100.4},0).wait(1).to({x:98.4},0).wait(1).to({x:96},0).wait(1).to({x:93.2},0).wait(1).to({x:90.25},0).wait(1).to({x:87.25},0).wait(1).to({x:84.6},0).wait(1).to({x:82.35},0).wait(1).to({x:80.55},0).wait(1).to({x:79.25},0).wait(1).to({x:78.3},0).wait(1).to({x:77.7},0).wait(1).to({x:77.4},0).wait(1).to({regX:-0.1,regY:0.1,x:-94.9,y:-47.25},0).to({_off:true},221).wait(495).to({_off:false,scaleX:0.5988,scaleY:0.5988,x:-25.4,y:-12.4},0).to({_off:true},109).wait(62));

	// bg_blur2
	this.bg2_2 = new lib.bg_zoom_half3();
	this.bg2_2.name = "bg2_2";
	this.bg2_2.parent = this;
	this.bg2_2.setTransform(-98.65,-59.85,0.8917,0.8917,0,0,0,-0.1,0.1);
	this.bg2_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg2_2).wait(507).to({_off:false},0).wait(334).to({regX:-0.2,scaleX:0.9867,scaleY:0.9867,x:-123,y:-76.7},19,cjs.Ease.quadInOut).to({_off:true},142).wait(171));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},1099).wait(74));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},1111).wait(57).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-282,-720,987.8,1340);
// library properties:
lib.properties = {
	id: '_418_2',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1600073852932", id:"_418_2_bg"},
		{src:"images/bg_blur.jpg?1600073852932", id:"_418_2_bg_blur"},
		{src:"images/ch_base.png?1600073852932", id:"_418_2_ch_base"},
		{src:"images/ch_base2.jpg?1600073852932", id:"_418_2_ch_base2"},
		{src:"images/ch_face10.png?1600073852932", id:"_418_2_ch_face10"},
		{src:"images/ch_face2.png?1600073852932", id:"_418_2_ch_face2"},
		{src:"images/ch_face3.png?1600073852932", id:"_418_2_ch_face3"},
		{src:"images/ch_face4.png?1600073852932", id:"_418_2_ch_face4"},
		{src:"images/ch_face5.png?1600073852932", id:"_418_2_ch_face5"},
		{src:"images/ch_face6.png?1600073852932", id:"_418_2_ch_face6"},
		{src:"images/ch_face7.png?1600073852932", id:"_418_2_ch_face7"},
		{src:"images/ch_face8.png?1600073852932", id:"_418_2_ch_face8"},
		{src:"images/ch_face9.png?1600073852932", id:"_418_2_ch_face9"},
		{src:"images/finish.jpg?1600073852932", id:"_418_2_finish"},
		{src:"images/finish_blur.jpg?1600073852932", id:"_418_2_finish_blur"},
		{src:"images/tie_fp.png?1600073852932", id:"_418_2_tie_fp"},
		{src:"images/tie_sp.png?1600073852932", id:"_418_2_tie_sp"}
	],
	preloads: []
};
