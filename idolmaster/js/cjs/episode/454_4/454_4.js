...
(lib.bg = function() {
	this.initialize(img._454_4__454_4_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1280,1400);


(lib.ch_base = function() {
	this.initialize(img._454_4__454_4_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1452,1600);


(lib.ch_face2 = function() {
	this.initialize(img._454_4__454_4_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,380,380);


(lib.ch_face3 = function() {
	this.initialize(img._454_4__454_4_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,380,380);


(lib.ch_face4 = function() {
	this.initialize(img._454_4__454_4_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,380,380);


(lib.ch_face5 = function() {
	this.initialize(img._454_4__454_4_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,380,380);


(lib.ch_face6 = function() {
	this.initialize(img._454_4__454_4_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,380,380);


(lib.ch_face7 = function() {
	this.initialize(img._454_4__454_4_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,380,380);


(lib.ch_face8 = function() {
	this.initialize(img._454_4__454_4_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,380,380);


(lib.EF = function() {
	this.initialize(img._454_4__454_4_EF);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1452,1600);


(lib.finish = function() {
	this.initialize(img._454_4__454_4_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._454_4__454_4_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._454_4__454_4_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._454_4__454_4_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.ef1_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0,0,0.3245,0.3245);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ef1_1, new cjs.Rectangle(0,0,471.1,519.2), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,726,800), null);
...
(lib.ef1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// ef1_1
	this.instance = new lib.ef1_1();
	this.instance.parent = this;
	this.instance.setTransform(235.6,259.6,1,1,0,0,0,235.6,259.6);
	this.instance.alpha = 0.6992;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0},20).to({alpha:0.6992},20).wait(1));

	// ef1_2
	this.instance_1 = new lib.ef1_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(235.5,259.6,1,1,0,0,180,235.6,259.6);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({alpha:0.6992},20).to({alpha:0},20).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,471.1,519.2);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(64,0.125);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AhGA/IAAgOIA+AAIAAhgIg4AAIAAgQICBAAIAAAQIg4AAIAABgIA/AAIAAAPg");
	this.shape_1.setTransform(48,0.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("");
	this.shape_2.setTransform(32,0.75);
	...
	this.shape_3.setTransform(16.125,0.975);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("AhGAvQAXgHAQgKQASgLAMgMQAKgMAHgNQAHgOADgNIhPAAIAAgRIBmAAQgDAUgIARQgGAQgKAMIAQAMIASAOIAQAQIgPAQQgLgPgLgLQgLgLgMgIQgKAMgLAJQgNAIgMAHIgYAKg");
	this.shape_4.setTransform(-0.15,0.95);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#333333").s().p("");
	this.shape_5.setTransform(-15.85,-0.125);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("AhAAvQAbgEATgJQATgHANgNQAOgMAJgQQAJgRAEgVIARAKIgIAXQgEANgIAMQgJAMgNAMQgMAKgTAKQgTAJgcAFgAgigeIgRgLIgPgIIAMgOIAKAGIANAHIANAJIAMAJIgOAPQgFgGgJgHg");
	this.shape_6.setTransform(-31.6,0.8);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("AgWgPIgiAEIgBgPIAigDIgDgdIAQgCIADAeIBBgHQgBAPgEAMQgFAMgIAJQgIALgKAGIgPgJQAJgGAHgGQAHgHAEgHQAEgIABgFIgsAEIAHBLIgQACg");
	this.shape_7.setTransform(-48.225,1.95);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#333333").s().p("AgHAXIg9AEIgBgQIA8gEIgDggIg3AFIgBgQIA3gFIgDgeIAQgBIADAeIA6gEIACAQIg6AEIADAgIA9gEIABAQIg8AEIAFAyIgRABg");
	this.shape_8.setTransform(-64.075,0.5);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).wait(8));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-202,160);
...
p.nominalBounds = new cjs.Rectangle(1,1,188,188);
...
(lib.window = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("Ag8A3IAbgIQAOgEALgGQALgFAHgGIgMgJIgOgJIgKgFIgDgCIANgSIAEACIALAHIANAIIAOAJQAJgJAGgJQAEgLAEgMIg9AAQgHALgIAHQgIAJgJAFIgMAKIgQgRIAOgJQAHgFAJgJQAJgJAIgLQAHgKAGgOIAVAFIgEAJIgFAHIBJAAIAAAUQgFASgIAQQgKARgOANQgOAOgUALQgTAMgcAHg");
	this.shape_1.setTransform(23.55,11.75);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("AKUD2IipgLInMhsIhkAAIiKAlIjKAlQiWgHisAEQh1ACgohTQgihFAehZQAXhEBtg/QBcg1BPgOQD6gcCNBhQAuAfAhAsQARAWAPAZQAQASA3gCQAzgCAtgSQANgFAdgmQAjguAegYQBxheDdAQQDhARBnB2QAzA8AHA3QAAC0iSAuQgrANgzAAIgHAAg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:95.2663,y:83.4863}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:95,regY:95,x:95,y:95,alpha:0.6441},0).wait(1).to({alpha:0.911},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:1},0).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:95,regY:95,x:95,y:95,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-322,-236,726,800);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-298,-292);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-418,-688,728.2,819.7);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-56.95,-438.8,1.1645,1.1645);
	this.instance._off = true;

	this.instance_1 = new lib.heart();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-67.65,-387.9,0.4532,0.4532);
	this.instance_1.alpha = 0;
	this.instance_1.compositeOperation = "lighter";
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-82.55,y:-447.8,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-94.2,y:-452.1,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-56.95,y:-438.8,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-82.55,y:-447.8,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-94.2,y:-452.1,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,rotation:0,x:-56.95,y:-438.8,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-82.55,y:-447.8,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-94.2,y:-452.1,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-56.95,y:-438.8,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-82.55,y:-447.8,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-94.2,y:-452.1,alpha:0.2188},0).to({_off:true},1).wait(110));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-69.4,y:-402.05,alpha:0.375},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-72.65,y:-407.9,alpha:0.5},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-70.1,y:-405.75,alpha:0.4444},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-69.55,y:-402.5,alpha:0.2778},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-70.65,y:-397.9,alpha:0},0).to({_off:true},1).wait(66));

	// effect
	this.instance_2 = new lib.spread_flower_pink("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-2.8,-344.65,1.4808,1.4808);

	this.instance_3 = new lib.good_effect("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(-2.8,-344.65,1.481,1.481);

	this.instance_4 = new lib.notice();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-74.5,-434.7,1.187,1.187,0,-169.8305,10.1695,-29.1,20.4);
	this.instance_4._off = true;

	this.instance_5 = new lib.laugh("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-95.25,-429.3,1.4204,1.4204,35.8424,0,0,-30.2,20.6);
	this.instance_5._off = true;

	this.instance_6 = new lib.chord("synched",0,false);
	this.instance_6.parent = this;
	this.instance_6.setTransform(-67.6,-347.05,1.0029,1.0029,-61.4995,0,0,-23.4,76.9);

	this.instance_7 = new lib.question();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-68.25,-431.65,1.053,1.053,-28.4906);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.instance_8 = new lib.mc_exclamation("synched",0,false);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-70.5,-446.35,1.0929,1.0929,-29.9996,0,0,0,0.1);

	this.instance_9 = new lib.drop1a("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-65,-427.75,1,1,0,0,0,-0.5,0.2);
	this.instance_9._off = true;

	this.instance_10 = new lib.drop2_v2("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-58.75,-429.05,0.9876,0.9876,14.9998);
	this.instance_10._off = true;

	this.instance_11 = new lib.shock("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(-68.35,-432.7,1.3878,1.3878,-121.2396);

	this.instance_12 = new lib.sigh("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(-45.85,-278.3);
	this.instance_12.alpha = 0.6016;
	this.instance_12._off = true;

	this.instance_13 = new lib.heart("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(-67.65,-387.9,0.4532,0.4532);
	this.instance_13._off = true;

	this.instance_14 = new lib.angry("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(70.3,-408,0.5276,0.5276);
	this.instance_14._off = true;

	this.instance_15 = new lib.mc_punpun();
	this.instance_15.parent = this;
	this.instance_15.setTransform(-60.75,-457.15,1.1377,1.1377);

	this.instance_16 = new lib.concent_wrapper("synched",0,false);
	this.instance_16.parent = this;
	this.instance_16.setTransform(-3.05,-345.2,1,1,0,0,0,-0.5,-0.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-74.1,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-74.5,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-74.1,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-74.5,alpha:0},0).to({_off:true},1).wait(283));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(160).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-97.9,y:-428.55,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.2,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-95.25,y:-429.3,alpha:0,startPosition:19},0).to({_off:true},1).wait(262));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:-75.2,y:-445.05,alpha:0.5556},0).wait(1).to({x:-79.3,y:-453.3,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-80.6,y:-456.35,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-80.35,y:-455.4},0).wait(1).to({x:-79.35,y:-453.55},0).wait(1).to({x:-77.65,y:-450.4},0).wait(1).to({regX:0,regY:0,x:-75.2,y:-446.35},0).to({x:-75.95,y:-447.7},2).wait(8).to({regX:-0.2,regY:0.2,x:-75.7,y:-446.8,alpha:0.9298},0).wait(1).to({x:-74.65,y:-444.85,alpha:0.692},0).wait(1).to({x:-73.05,y:-441.95,alpha:0.339},0).wait(1).to({x:-71.9,y:-439.8,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-71.45,y:-439.5,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:-68.7,y:-431.25},0).wait(1).to({regX:-0.2,regY:0.2,x:-75.65,y:-444.65,alpha:0.5556},0).wait(1).to({x:-79.75,y:-452.9,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-81.05,y:-455.95,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-80.8,y:-455},0).wait(1).to({x:-79.8,y:-453.15},0).wait(1).to({x:-78.1,y:-450},0).wait(1).to({regX:0,regY:0,x:-75.65,y:-445.95},0).to({x:-76.4,y:-447.3},2).wait(3).to({regX:-0.2,regY:0.2,x:-76.15,y:-446.4,alpha:0.9298},0).wait(1).to({x:-75.1,y:-444.45,alpha:0.692},0).wait(1).to({x:-73.5,y:-441.55,alpha:0.339},0).wait(1).to({x:-72.35,y:-439.4,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-71.9,y:-439.1,alpha:0},0).to({_off:true},1).wait(195));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:-64,y:-424.05},0).wait(1).to({y:-420.2},0).wait(1).to({y:-416.95},0).wait(1).to({y:-414.3},0).wait(1).to({y:-412.2},0).wait(1).to({y:-410.7},0).wait(1).to({y:-409.8},0).wait(1).to({regX:-0.5,regY:0.2,x:-65,y:-408.75},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:-64,y:-409.55,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:-65,y:-408.75,alpha:0},0).to({_off:true},1).wait(153));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-90.175,y:-424.4375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-100.65,y:-422.9,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-58.75,y:-429.05,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-90.175,y:-428.825,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-100.65,y:-428.75,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-58.75,y:-429.05,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-90.175,y:-424.4375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-100.65,y:-422.9,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-58.75,y:-429.05,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-90.175,y:-428.825,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-100.65,y:-428.75,alpha:0.2188},0).to({_off:true},1).wait(110));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(351).to({_off:false},0).wait(1).to({x:-46.85,y:-277.3,alpha:1},0).wait(1).to({regX:0.9,x:-46.95,y:-276.35,alpha:0.8965},0).wait(1).to({x:-48.3,y:-275.15,alpha:0.7636},0).wait(1).to({x:-49.9,y:-273.7,alpha:0.6048},0).wait(1).to({x:-51.7,y:-272.1,alpha:0.4229},0).wait(1).to({x:-53.7,y:-270.25,alpha:0.2205},0).wait(1).to({regX:0,x:-56.85,y:-268.3,alpha:0},0).to({_off:true},1).wait(83));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-69.4,y:-402.05},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-72.65,y:-407.9},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-70.1,y:-405.75},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-69.55,y:-402.5},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-70.65,y:-397.9},0).to({scaleX:1,scaleY:1,x:-71.65,y:-401.9},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:-69.05,y:-400.9,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:-70.65,y:-401.65,alpha:0.1016},0).to({_off:true},1).wait(59));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-411.75},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-413},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(40));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:-55,regY:-288,x:-55,y:-292.75},0).wait(1).to({regX:0,regY:0,x:0,y:-5.7},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-293.15},0).wait(1).to({y:-291.3},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-293.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-293.75},0).wait(1).to({y:-286.8},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-284.75},0).wait(1).to({y:-287.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-292.95},0).wait(1).to({y:-287.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-292.95},0).wait(1).to({y:-287.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-287.1},0).wait(1).to({y:-287.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-297},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-300.95},0).wait(1).to({y:-297.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-286},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-288.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-297},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-300.95},0).wait(1).to({y:-297.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-286},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-288.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-55,regY:-288,x:-55,y:-287.4},0).wait(1).to({y:-285},0).wait(1).to({y:-282.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-282.65},0).wait(1).to({y:-285},0).wait(1).to({y:-287.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-55,regY:-288,x:-55,y:-287.85},0).wait(1).to({y:-287.3},0).wait(1).to({y:-286.2},0).wait(1).to({y:-284.85},0).wait(1).to({y:-283.75},0).wait(1).to({y:-283.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-283.2},0).wait(1).to({y:-283.75},0).wait(1).to({y:-284.85},0).wait(1).to({y:-286.2},0).wait(1).to({y:-287.3},0).wait(1).to({y:-287.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:-55,regY:-288,x:-55,y:-283.25},0).wait(1).to({y:-286.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:-55,regY:-288,x:-55,y:-285.8},0).wait(1).to({y:-287.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-55,regY:-288,rotation:-0.0201,x:-55.1,y:-287.95},0).wait(1).to({rotation:-0.0899,x:-55.35,y:-287.55},0).wait(1).to({rotation:-0.2264,x:-55.8,y:-286.9},0).wait(1).to({rotation:-0.4429,x:-56.5,y:-285.85},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.7146,x:-57.45,y:-284.4},0).wait(1).to({rotation:-0.961,x:-58.3,y:-283.2},0).wait(1).to({rotation:-1.1253,x:-58.85,y:-282.25},0).wait(1).to({rotation:-1.2097,x:-59.15,y:-281.85},0).wait(1).to({regX:0,regY:0,rotation:-1.2339,x:2,y:5},0).wait(1).to({regX:-55,regY:-288,rotation:-1.218,x:-59.15,y:-281.85},0).wait(1).to({rotation:-1.164,x:-59,y:-282.1},0).wait(1).to({rotation:-1.0598,x:-58.6,y:-282.65},0).wait(1).to({rotation:-0.8934,x:-58.1,y:-283.55},0).wait(1).to({rotation:-0.6684,x:-57.3,y:-284.65},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.428,x:-56.5,y:-285.9},0).wait(1).to({rotation:-0.2331,x:-55.85,y:-286.95},0).wait(1).to({rotation:-0.107,x:-55.45,y:-287.6},0).wait(1).to({rotation:-0.0417,x:-55.2,y:-287.9},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-55,regY:-288,rotation:-0.0253,x:-55.1,y:-287.95},0).wait(1).to({rotation:-0.1129,x:-55.45,y:-287.55},0).wait(1).to({rotation:-0.2845,x:-56.1,y:-286.85},0).wait(1).to({rotation:-0.5565,x:-57.1,y:-285.65},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:-58.35,y:-284.25},0).wait(1).to({rotation:-1.2075,x:-59.5,y:-282.9},0).wait(1).to({rotation:-1.4141,x:-60.3,y:-282},0).wait(1).to({rotation:-1.5201,x:-60.65,y:-281.5},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(1).to({regX:-55,regY:-288,rotation:-1.5302,x:-60.7,y:-281.5},0).wait(1).to({rotation:-1.461,x:-60.5,y:-281.75},0).wait(1).to({rotation:-1.3276,x:-59.95,y:-282.4},0).wait(1).to({rotation:-1.1146,x:-59.2,y:-283.3},0).wait(1).to({rotation:-0.8266,x:-58.1,y:-284.5},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.5189,x:-56.95,y:-285.8},0).wait(1).to({rotation:-0.2693,x:-56.05,y:-286.9},0).wait(1).to({rotation:-0.1079,x:-55.45,y:-287.6},0).wait(1).to({rotation:-0.0243,x:-55.1,y:-287.95},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:-55,regY:-288,x:-55,y:-293.55},0).wait(1).to({y:-295.45},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-295.35},0).wait(1).to({y:-293.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:-55,regY:-288,x:-55,y:-296.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-297.2},0).wait(1).to({y:-294.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:-55,regY:-288,rotation:-0.0229,x:-55.1,y:-287.9},0).wait(1).to({rotation:-0.1024,x:-55.4,y:-287.25},0).wait(1).to({regX:0,regY:0,rotation:-0.2579,x:0.35,y:1.65},0).wait(1).to({regX:-55,regY:-288,rotation:-0.5356,x:-57,y:-284.25},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.8843,x:-58.35,y:-281.9},0).wait(1).to({rotation:-1.2003,x:-59.5,y:-279.75},0).wait(1).to({rotation:-1.4112,x:-60.3,y:-278.35},0).wait(1).to({rotation:-1.5195,x:-60.65,y:-277.6},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:9},0).wait(1).to({regX:-55,regY:-288,rotation:-1.5305,x:-60.7,y:-277.55},0).wait(1).to({rotation:-1.4624,x:-60.45,y:-278},0).wait(1).to({rotation:-1.3309,x:-60,y:-278.9},0).wait(1).to({rotation:-1.121,x:-59.25,y:-280.35},0).wait(1).to({rotation:-0.8372,x:-58.15,y:-282.4},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:-57.05,y:-284.45},0).wait(1).to({rotation:-0.2881,x:-56.15,y:-286.15},0).wait(1).to({rotation:-0.1291,x:-55.55,y:-287.3},0).wait(1).to({rotation:-0.0467,x:-55.25,y:-287.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-55,regY:-288,rotation:-0.147,x:-55.6,y:-287.4},0).wait(1).to({rotation:-0.7239,x:-57.75,y:-284.95},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.3727,x:-60.15,y:-282.2},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(18).to({regX:-55,regY:-288,rotation:-1.4913,x:-60.55,y:-281.6},0).wait(1).to({rotation:-1.2701,x:-59.8,y:-282.65},0).wait(1).to({rotation:-0.8372,x:-58.15,y:-284.5},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:-56.4,y:-286.55},0).wait(1).to({rotation:-0.094,x:-55.4,y:-287.7},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-55,regY:-288,rotation:-0.0894,x:-55.35,y:-287.65},0).wait(1).to({rotation:-0.4358,x:-56.65,y:-286.2},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.0316,x:-58.9,y:-283.65},0).wait(1).to({rotation:-1.4426,x:-60.4,y:-281.8},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(8).to({regX:-55,regY:-288,rotation:-1.4913,x:-60.55,y:-281.6},0).wait(1).to({rotation:-1.2701,x:-59.8,y:-282.65},0).wait(1).to({rotation:-0.8372,x:-58.15,y:-284.5},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:-56.4,y:-286.55},0).wait(1).to({rotation:-0.094,x:-55.4,y:-287.7},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-296.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-297.2},0).wait(1).to({y:-294.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-55,regY:-288,x:-57.75,y:-280.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:-55,regY:-288,x:-55,y:-275.75},0).wait(1).to({y:-278.7},0).wait(1).to({y:-283.65},0).wait(1).to({y:-287.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-287},0).wait(1).to({y:-281.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:-55,regY:-288,x:-55,y:-280.2},0).wait(1).to({y:-284.5},0).wait(1).to({y:-288.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-288.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-55,regY:-288,x:-55,y:-294.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-294.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-296.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-297.2},0).wait(1).to({y:-294.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-55,regY:-288,x:-57.75,y:-280.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:-55,regY:-288,x:-55,y:-277.25},0).wait(1).to({y:-285},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-289},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-288.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-287.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-55,regY:-288,x:-55,y:-287.4},0).wait(1).to({y:-285},0).wait(1).to({y:-282.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-282.6},0).wait(1).to({y:-282.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:-55,regY:-288,x:-55,y:-283.4},0).wait(1).to({y:-284.9},0).wait(1).to({y:-287.15},0).wait(1).to({y:-288.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-288.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-295.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-297.2},0).wait(1).to({y:-294.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:-55,regY:-288,x:-55,y:-295.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:-55,regY:-288,x:-55,y:-296},0).wait(1).to({y:-290},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:-55,regY:-288,x:-55,y:-283.35},0).wait(1).to({y:-284.55},0).wait(1).to({y:-286.5},0).wait(1).to({y:-287.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-292.95},0).wait(1).to({y:-287.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-292.95},0).wait(1).to({y:-287.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-55,regY:-288,x:-55,y:-287.1},0).wait(1).to({y:-287.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-55,regY:-288,x:-52,y:-284.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:-55,regY:-288,x:-55.85,y:-278.55},0).wait(1).to({x:-55.2,y:-278.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:-55,regY:-288,x:-55,y:-278.7},0).wait(1).to({y:-281.15},0).wait(1).to({y:-284.85},0).wait(1).to({y:-287.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(10));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-456.9,-745.5,861.5,878);
...
// stage content:
(lib._454_4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:176,scene2:177,end2:301,scene3:302,end3:445,scene4:446,end4:568,scene5:569,end5:702,scene6:703,end6:846,scene7:847,end7:1001});
	...
	this.frame_317 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "れて嬉しいな｡";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 7);
	}
	this.frame_362 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "わせて作り上げる学園祭｡";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 2);
		this.ch1.gotoAndPlay("swing");
	}
	...
	this.frame_470 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "して､笑いあったり｡";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 7);
	}
	this.frame_505 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "憧れてたんだ｡";
		exportRoot._u.setText();
	...
	this.frame_724 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "めの私､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 1);
	}
	this.frame_736 = function() {
		exportRoot._g.m2 = "めの私､で頑張るね｡";
		exportRoot._u.setText();
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(21).call(this.frame_36).wait(37).call(this.frame_73).wait(11).call(this.frame_84).wait(37).call(this.frame_121).wait(34).call(this.frame_155).wait(21).call(this.frame_176).wait(1).call(this.frame_177).wait(15).call(this.frame_192).wait(22).call(this.frame_214).wait(36).call(this.frame_250).wait(26).call(this.frame_276).wait(25).call(this.frame_301).wait(1).call(this.frame_302).wait(15).call(this.frame_317).wait(45).call(this.frame_362).wait(21).call(this.frame_383).wait(28).call(this.frame_411).wait(17).call(this.frame_428).wait(2).call(this.frame_430).wait(15).call(this.frame_445).wait(1).call(this.frame_446).wait(24).call(this.frame_470).wait(35).call(this.frame_505).wait(30).call(this.frame_535).wait(15).call(this.frame_550).wait(18).call(this.frame_568).wait(1).call(this.frame_569).wait(11).call(this.frame_580).wait(16).call(this.frame_596).wait(21).call(this.frame_617).wait(31).call(this.frame_648).wait(21).call(this.frame_669).wait(1).call(this.frame_670).wait(32).call(this.frame_702).wait(1).call(this.frame_703).wait(21).call(this.frame_724).wait(12).call(this.frame_736).wait(14).call(this.frame_750).wait(22).call(this.frame_772).wait(29).call(this.frame_801).wait(18).call(this.frame_819).wait(9).call(this.frame_828).wait(18).call(this.frame_846).wait(1).call(this.frame_847).wait(12).call(this.frame_859).wait(35).call(this.frame_894).wait(31).call(this.frame_925).wait(43).call(this.frame_968).wait(33).call(this.frame_1001).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1006));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1001).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1006));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(987));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},12).to({state:[]},3).to({state:[{t:this.instance_3}]},162).to({state:[{t:this.instance_3}]},3).to({state:[]},1).wait(825));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(177).to({_off:false},0).to({alpha:0.1016},3).to({_off:true},1).wait(825));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(17).to({alpha:0.1016},3).to({_off:true},1).wait(985));

	// window
	this.window_1 = new lib.window_container();
	this.window_1.name = "window_1";
	this.window_1.parent = this;
	this.window_1.setTransform(2,301.1);

	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(16).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(916).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(956).to({_off:false},0).wait(1).to({regX:16.8,regY:-1.3,x:136.8,y:320.2},0).wait(1).to({y:318.5},0).wait(1).to({y:315.2},0).wait(1).to({y:309.85},0).wait(1).to({y:302.4},0).wait(1).to({y:294.05},0).wait(1).to({y:287.1},0).wait(1).to({y:282.55},0).wait(1).to({y:280.25},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(37));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5}]},956).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(956).to({_off:false},0).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.ranko_finish_blur).wait(956).to({_off:false},0).wait(1).to({regX:120,regY:155,x:120,y:155,alpha:0.8489},0).wait(1).to({alpha:0.8403},0).wait(1).to({alpha:0.8253},0).wait(1).to({alpha:0.8029},0).wait(1).to({alpha:0.7723},0).wait(1).to({alpha:0.7324},0).wait(1).to({alpha:0.6823},0).wait(1).to({alpha:0.6211},0).wait(1).to({alpha:0.5487},0).wait(1).to({alpha:0.4662},0).wait(1).to({alpha:0.3767},0).wait(1).to({alpha:0.2865},0).wait(1).to({alpha:0.2036},0).wait(1).to({alpha:0.1357},0).wait(1).to({alpha:0.0874},0).wait(1).to({alpha:0.0595},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0.0508},0).to({_off:true},1).wait(32));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(956).to({_off:false},0).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(944).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(847).to({_off:false},0).to({alpha:0},7).to({_off:true},1).wait(151));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13},{t:this.instance_12}]}).to({state:[]},15).wait(991));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(177).to({_off:false},0).to({y:-113},8).wait(66).to({regX:1,x:121,y:-113.55},0).wait(1).to({y:-115.3},0).wait(1).to({y:-118.05},0).wait(1).to({y:-121.85},0).wait(1).to({y:-126.45},0).wait(1).to({y:-131.85},0).wait(1).to({y:-137.85},0).wait(1).to({y:-144.35},0).wait(1).to({y:-151.2},0).wait(1).to({y:-158.2},0).wait(1).to({y:-165.15},0).wait(1).to({y:-171.95},0).wait(1).to({y:-178.4},0).wait(1).to({y:-184.25},0).wait(1).to({y:-189.4},0).wait(1).to({y:-193.7},0).wait(1).to({y:-196.9},0).wait(1).to({y:-198.9},0).wait(1).to({regX:0,x:120,y:-199.65},0).to({_off:true},1).wait(736));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(177).to({_off:false},0).to({y:350},8).wait(66).to({regX:1,x:121,y:351.05},0).wait(1).to({y:354.2},0).wait(1).to({y:359.25},0).wait(1).to({y:366.1},0).wait(1).to({y:374.55},0).wait(1).to({y:384.4},0).wait(1).to({y:395.35},0).wait(1).to({y:407.2},0).wait(1).to({y:419.65},0).wait(1).to({y:432.4},0).wait(1).to({y:445.15},0).wait(1).to({y:457.5},0).wait(1).to({y:469.25},0).wait(1).to({y:479.95},0).wait(1).to({y:489.35},0).wait(1).to({y:497.15},0).wait(1).to({y:503},0).wait(1).to({y:506.7},0).wait(1).to({regX:0,x:120,y:508},0).to({_off:true},1).wait(736));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(569).to({_off:false},0).to({alpha:1},37).to({_off:true},241).wait(159));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(569).to({_off:false},0).to({alpha:0.4492},37).to({_off:true},241).wait(159));

	// ef
	this.instance_16 = new lib.ef1();
	this.instance_16.parent = this;
	this.instance_16.setTransform(81,134.25,1.21,1.21,0,0,0,235.5,259.6);
	this.instance_16.compositeOperation = "lighter";
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(15).to({_off:false},0).wait(21).to({regX:235.4,regY:259.5,scaleX:1.2556,scaleY:1.2556,x:78.45,y:145.95},17,cjs.Ease.quadInOut).wait(31).to({y:175.65},37,cjs.Ease.quadInOut).to({regY:259.4,scaleX:1.0413,scaleY:1.0413,x:87.7,y:170.05},30,cjs.Ease.quadInOut).wait(26).to({regX:235.5,regY:259.5,scaleX:1.0016,scaleY:1.0016,x:238.6,y:172.9},0).to({x:204.2,y:170.1},73).to({regX:235.2,regY:259.4,scaleX:0.692,scaleY:0.692,x:97.9,y:148.6},19,cjs.Ease.quadInOut).wait(33).to({regY:259.3,scaleX:0.8513,scaleY:0.8513,x:92.6,y:160},60,cjs.Ease.quadInOut).wait(84).to({scaleX:0.9167,scaleY:0.9167,x:90.55,y:167.35},15).wait(108).to({alpha:0},11).to({_off:true},1).wait(425));
	...
	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.4,regY:0.2,scaleX:0.7893,scaleY:0.7893,x:122.35,y:358.6},0).wait(21).to({regX:0.6,regY:0.4,scaleX:0.8299,scaleY:0.8299,x:123.4,y:385.25},17,cjs.Ease.quadInOut).wait(31).to({y:414.95},37,cjs.Ease.quadInOut).to({regX:0.5,scaleX:0.6792,scaleY:0.6792,y:363.3},30,cjs.Ease.quadInOut).wait(26).to({regX:0.6,regY:0.7,scaleX:0.6485,scaleY:0.6485,x:325.75,y:360.75},0).to({regY:0.8,scaleX:0.6484,scaleY:0.6484,x:290.7,y:360.8},73).to({regY:0.7,scaleX:0.4532,scaleY:0.4532,x:122.1,y:277.55},19,cjs.Ease.quadInOut).wait(33).to({regX:0.7,scaleX:0.5575,scaleY:0.5575,x:122.35,y:318.6},60,cjs.Ease.quadInOut).wait(84).to({regX:0.8,regY:0.8,scaleX:0.6003,scaleY:0.6003,x:122.6,y:338.2},15).wait(108).to({alpha:0},11).to({_off:true},1).wait(425));
	...
	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({regX:-0.1,regY:0.1,scaleX:0.8953,scaleY:0.8953,x:-207.7,y:-179.75},0).wait(21).to({regX:-0.2,regY:-0.1,scaleX:0.9255,scaleY:0.9255,x:-218.45,y:-178},17,cjs.Ease.quadInOut).wait(31).to({y:-148.3},37,cjs.Ease.quadInOut).to({scaleX:0.7705,scaleY:0.7705,x:-160.7,y:-100.15},30,cjs.Ease.quadInOut).wait(26).to({regY:0,scaleX:0.7411,scaleY:0.7411,x:0.15,y:-85.8},0).to({x:-34.8},73).to({regX:-0.4,regY:-0.1,scaleX:0.514,scaleY:0.514,x:-67.4,y:-31.65},19,cjs.Ease.quadInOut).wait(33).to({regX:-0.6,scaleX:0.6324,scaleY:0.6324,x:-110.85,y:-61.7},60,cjs.Ease.quadInOut).wait(84).to({regY:-0.2,scaleX:0.681,scaleY:0.681,x:-128.5,y:-71.45},15).wait(108).to({alpha:0},11).to({_off:true},1).wait(425));

	// ef2
	this.instance_17 = new lib.ef1();
	this.instance_17.parent = this;
	this.instance_17.setTransform(88.05,174.5,0.9951,0.9951,0,0,0,235.2,259.4);
	this.instance_17.compositeOperation = "lighter";
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(558).to({_off:false},0).wait(145).to({regX:235.1,regY:259.3,scaleX:1.2062,scaleY:1.2062,x:81.15,y:184.05},30,cjs.Ease.quadInOut).wait(114).to({regX:235,regY:259.4,scaleX:0.6148,scaleY:0.6148,x:101.35,y:151.65},0).to({_off:true},109).wait(50));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(121.75,312.8,0.6516,0.6516,0,0,0,0.8,0.8);
	this.ch2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(558).to({_off:false},0).wait(11).to({x:122.75,y:357.8},27,cjs.Ease.quadInOut).wait(107).to({scaleX:0.7899,scaleY:0.7899,x:123.35,y:408.75},30,cjs.Ease.quadInOut).wait(114).to({regX:1,regY:1,scaleX:0.4026,scaleY:0.4026,x:122.8,y:266.15},0).to({_off:true},109).wait(50));

	// bg2
	this.bg1_1 = new lib.bg_zoom_half();
	this.bg1_1.name = "bg1_1";
	this.bg1_1.parent = this;
	this.bg1_1.setTransform(-150.8,-131.7,0.7392,0.7392,0,0,0,-0.6,-0.1);
	this.bg1_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg1_1).wait(558).to({_off:false},0).wait(11).to({x:-149.8,y:-86.7},27,cjs.Ease.quadInOut).wait(107).to({scaleX:0.896,scaleY:0.896,x:-207,y:-130.1},30,cjs.Ease.quadInOut).wait(114).to({regX:-0.9,regY:-0.2,scaleX:0.4567,scaleY:0.4567,x:-45.6,y:-8.5},0).to({_off:true},109).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},944).wait(62));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},956).wait(45).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-282,-720,1092.9,1383);
// library properties:
lib.properties = {
	id: '_454_4',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1629872973126", id:"_454_4__454_4_bg"},
		{src:"images/ch_base.png?1629872973126", id:"_454_4__454_4_ch_base"},
		{src:"images/ch_face2.png?1629872973126", id:"_454_4__454_4_ch_face2"},
		{src:"images/ch_face3.png?1629872973126", id:"_454_4__454_4_ch_face3"},
		{src:"images/ch_face4.png?1629872973126", id:"_454_4__454_4_ch_face4"},
		{src:"images/ch_face5.png?1629872973126", id:"_454_4__454_4_ch_face5"},
		{src:"images/ch_face6.png?1629872973126", id:"_454_4__454_4_ch_face6"},
		{src:"images/ch_face7.png?1629872973126", id:"_454_4__454_4_ch_face7"},
		{src:"images/ch_face8.png?1629872973126", id:"_454_4__454_4_ch_face8"},
		{src:"images/EF.png?1629872973126", id:"_454_4__454_4_EF"},
		{src:"images/finish.jpg?1629872973126", id:"_454_4__454_4_finish"},
		{src:"images/finish_blur.jpg?1629872973126", id:"_454_4__454_4_finish_blur"},
		{src:"images/tie_fp.png?1629872973126", id:"_454_4__454_4_tie_fp"},
		{src:"images/tie_sp.png?1629872973126", id:"_454_4__454_4_tie_sp"}
	],
	preloads: []
};
