...
(lib.bg = function() {
	this.initialize(img._444_4_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,960,1400);


(lib.ch_base = function() {
	this.initialize(img._444_4_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1120,1400);


(lib.ch_face10 = function() {
	this.initialize(img._444_4_ch_face10);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face11 = function() {
	this.initialize(img._444_4_ch_face11);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face12 = function() {
	this.initialize(img._444_4_ch_face12);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face2 = function() {
	this.initialize(img._444_4_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face3 = function() {
	this.initialize(img._444_4_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face4 = function() {
	this.initialize(img._444_4_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face5 = function() {
	this.initialize(img._444_4_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face6 = function() {
	this.initialize(img._444_4_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face7 = function() {
	this.initialize(img._444_4_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face8 = function() {
	this.initialize(img._444_4_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face9 = function() {
	this.initialize(img._444_4_ch_face9);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ef01 = function() {
	this.initialize(img._444_4_ef01);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,960,1400);


(lib.finish = function() {
	this.initialize(img._444_4_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._444_4_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.kirakira = function() {
	this.initialize(img._444_4_kirakira);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,213,209);


(lib.tie_fp = function() {
	this.initialize(img._444_4_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._444_4_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.シンボル1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0,0,0.6331,0.6331);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.シンボル1, new cjs.Rectangle(0,0,607.8,886.4), null);
...
(lib.eff02 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-56.3,-62.2,0.5643,0.5643,3.2118);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-62.9,-62.2,126.6,124.5);
...
p.nominalBounds = new cjs.Rectangle(0,0,480,700);
...
(lib.concent = function(mode,startPosition,loop) {
	...
	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AAm/qMAAYA/AIh7AVg");
	this.shape.setTransform(3.425,306.625);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.concent, new cjs.Rectangle(-2.7,104,12.3,405.3), null);
...
p.nominalBounds = new cjs.Rectangle(-58.8,-58.4,117.6,117.69999999999999);


(lib.ef2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// ef03
	this.instance = new lib.シンボル1();
	this.instance.parent = this;
	this.instance.setTransform(303.9,443.2,1,1,0,0,0,303.9,443.2);
	this.instance.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0.3984},20).to({alpha:1},20).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-93,0,710.1,886.7);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(39.8,0.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("");
	this.shape_1.setTransform(23.8,0.45);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("");
	this.shape_2.setTransform(8.05,0.35);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("Ag7A4QAbgDASgKQASgIAMgMQAMgNAIgOQAHgPAFgPIg1AAQgJANgMAMQgMAMgPAKIgPgNQAMgGAKgIQAJgJAIgKQAIgJAFgKQAFgKACgKIASAFIgDAIIgEAJIANAAIARAAIARAAIAMAAIAIAAQgCANgFAOQgEAPgHANQgIAPgMANQgMANgTALQgSAKgbAGg");
	this.shape_3.setTransform(-8.65,0.45);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("AgqApQAbgGAPgMQARgLAJgSQAJgTABgdIASADQgCAUgFARQgFAQgJANQgJAOgPAJQgPAKgWAHgAgrgPIgEgQIgGgOIAQgEIAFANIAFAQIAEAPIgQAFIgEgPgAgGgTIgEgRIgFgOIAPgDIAFAOIAEAPIADAPIgPAEIgDgOg");
	this.shape_4.setTransform(-24.25,2.125);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#333333").s().p("Ag9AyQAbgCAUgJQATgJAOgNQAOgOAJgPQAJgQAGgSIAPAMIgKAXQgGAMgJAMQgJANgNALQgOAKgSAJQgSAHgaAEgAgnAAIgQgIIgQgGIAJgPIAPAFIARAIIAQAJIgIAPIgRgIgAgRgnIgQgHIgQgGIAJgPIAPAGIARAHQAIADAGAFIgHARIgQgKg");
	this.shape_5.setTransform(-39.925,0.65);
...
}).prototype = getMCSymbolPrototype(lib.concent_container, new cjs.Rectangle(-442.4,-437.9,887.7,887.0999999999999), null);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("Al8D8QgkgGgVgTQgZgWgWgxQgZg4ALg7QALg+A0g9QA1hABSgLQBUgMAoA2QAVAbAuBSQAvBCAxgEQArgDAWg2IApiUQAPg2BMggQBQgiBAAiQBAAiAnApQAfAiAZAxQAYAvgNA0QgLAvgfAdQgiAegmANQhBAWhagRQhcgSgzgDQgvgDgtAHQgtAHguAQQgzARghAXQgmAag/AUQgzAPgfAAIgQgBg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:59.8338,y:50.4491}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(40.35,-549.8,0.6148,0.6148,42.2037,0,0,0.1,-0.8);
	this.instance.compositeOperation = "lighter";

	this.instance_1 = new lib.eff02_m();
	this.instance_1.parent = this;
	this.instance_1.setTransform(58.4,-539.9,0.4293,0.4293,42.2037,0,0,0.2,-0.8);
	this.instance_1.compositeOperation = "lighter";

	this.instance_2 = new lib.eff02_m();
	this.instance_2.parent = this;
	this.instance_2.setTransform(96.9,-542,0.5155,0.5155,42.2033,0,0,-0.1,-0.8);
	this.instance_2.compositeOperation = "lighter";

	this.instance_3 = new lib.eff02_m();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-162.6,-515.45,0.5155,0.5155,42.2033,0,0,-0.1,-0.8);
	this.instance_3.compositeOperation = "lighter";

	this.instance_4 = new lib.eff02_m();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-106.35,-506.15,0.4293,0.4293,42.2037,0,0,0.2,-0.8);
	this.instance_4.compositeOperation = "lighter";

	this.instance_5 = new lib.eff02_m();
	this.instance_5.parent = this;
	this.instance_5.setTransform(49.05,-417.3,0.3181,0.3181,42.2046,0,0,0.2,-0.9);
	this.instance_5.compositeOperation = "lighter";

	this.instance_6 = new lib.eff02_m();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-39.35,-379.95,0.2698,0.2698,42.2033,0,0,-0.1,-0.9);
	this.instance_6.compositeOperation = "lighter";

	this.instance_7 = new lib.eff02_m();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-55.45,-399.05,0.3181,0.3181,42.2046,0,0,0.2,-0.9);
	this.instance_7.compositeOperation = "lighter";

	this.instance_8 = new lib.eff02_m();
	this.instance_8.parent = this;
	this.instance_8.setTransform(27.8,-364,0.4339,0.4339,42.2048,0,0,0.4,-0.8);
	this.instance_8.compositeOperation = "lighter";

	this.instance_9 = new lib.eff02_m();
	this.instance_9.parent = this;
	this.instance_9.setTransform(78,-446.65,0.5499,0.5499,42.2043,0,0,0.4,-0.8);
	...
	this.f.name = "f";
	this.f.parent = this;
	this.f.setTransform(-75.8,-508.15);
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-4.4,-9.55,1,1,0,0,0,125.4,276.6);
	...
	this.instance_10.parent = this;
	this.instance_10.setTransform(-94.85,-281.95,0.3641,0.3641,42.2012,0,0,0.1,-1.2);
	this.instance_10.compositeOperation = "lighter";

	this.instance_11 = new lib.eff02_m();
	this.instance_11.parent = this;
	this.instance_11.setTransform(186.35,-257.15,0.7748,0.7748,42.2033,0,0,0.4,-1.2);
	this.instance_11.compositeOperation = "lighter";

	this.instance_12 = new lib.eff02_m();
	this.instance_12.parent = this;
	this.instance_12.setTransform(151.75,-344.1,0.5762,0.5762,42.2039,0,0,0.4,-1.1);
	this.instance_12.compositeOperation = "lighter";

	this.instance_13 = new lib.eff02_m();
	this.instance_13.parent = this;
	this.instance_13.setTransform(108.35,-363.7,0.3124,0.3124,42.2044,0,0,0.5,-0.9);
	this.instance_13.compositeOperation = "lighter";

	this.instance_14 = new lib.eff02_m();
	this.instance_14.parent = this;
	this.instance_14.setTransform(131.5,-409.5,0.4339,0.4339,42.2048,0,0,0.4,-0.8);
	this.instance_14.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10}]}).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-249.8,-682.1,560,813.8);
...
(lib.concent_wrapper = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:1.4,regY:5.6,x:1.4,y:5.6,alpha:0.9972},0).wait(1).to({alpha:0.9886},0).wait(1).to({alpha:0.9735},0).wait(1).to({alpha:0.9514},0).wait(1).to({alpha:0.9216},0).wait(1).to({alpha:0.8835},0).wait(1).to({alpha:0.8365},0).wait(1).to({alpha:0.7801},0).wait(1).to({alpha:0.7144},0).wait(1).to({alpha:0.6398},0).wait(1).to({alpha:0.5579},0).wait(1).to({alpha:0.4715},0).wait(1).to({alpha:0.3849},0).wait(1).to({alpha:0.3032},0).wait(1).to({alpha:0.2316},0).wait(1).to({alpha:0.1742},0).wait(1).to({alpha:0.1333},0).wait(1).to({alpha:0.1093},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0.1016},0).to({_off:true},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-442.4,-437.9,887.7,887.0999999999999);
...
(lib.character1_container = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{standby:0,jump:8,jump2:16,jump_double:25,jump_flower:37,jump_flower2:47,nod:57,nod2:66,nod_double:81,swing:92,swing_on:110,swing_off:119,notice:130,notice_jump:144,laugh:158,chord:179,question:199,question_on:227,question_off:239,exclamation:250,down:266,down2:293,shy_jump:311,shy_down:319,shock:337,sigh:344,happy:363,anger:378,anger2:398,damage:410,concent:427});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(7).call(this.frame_7).wait(1).call(this.frame_8).wait(7).call(this.frame_15).wait(1).call(this.frame_16).wait(8).call(this.frame_24).wait(1).call(this.frame_25).wait(11).call(this.frame_36).wait(1).call(this.frame_37).wait(9).call(this.frame_46).wait(1).call(this.frame_47).wait(9).call(this.frame_56).wait(1).call(this.frame_57).wait(8).call(this.frame_65).wait(1).call(this.frame_66).wait(14).call(this.frame_80).wait(1).call(this.frame_81).wait(10).call(this.frame_91).wait(1).call(this.frame_92).wait(17).call(this.frame_109).wait(1).call(this.frame_110).wait(8).call(this.frame_118).wait(1).call(this.frame_119).wait(10).call(this.frame_129).wait(1).call(this.frame_130).wait(13).call(this.frame_143).wait(1).call(this.frame_144).wait(13).call(this.frame_157).wait(1).call(this.frame_158).wait(20).call(this.frame_178).wait(1).call(this.frame_179).wait(19).call(this.frame_198).wait(1).call(this.frame_199).wait(27).call(this.frame_226).wait(1).call(this.frame_227).wait(11).call(this.frame_238).wait(1).call(this.frame_239).wait(10).call(this.frame_249).wait(1).call(this.frame_250).wait(15).call(this.frame_265).wait(1).call(this.frame_266).wait(26).call(this.frame_292).wait(1).call(this.frame_293).wait(17).call(this.frame_310).wait(1).call(this.frame_311).wait(7).call(this.frame_318).wait(1).call(this.frame_319).wait(17).call(this.frame_336).wait(1).call(this.frame_337).wait(6).call(this.frame_343).wait(1).call(this.frame_344).wait(18).call(this.frame_362).wait(1).call(this.frame_363).wait(14).call(this.frame_377).wait(1).call(this.frame_378).wait(19).call(this.frame_397).wait(1).call(this.frame_398).wait(11).call(this.frame_409).wait(1).call(this.frame_410).wait(16).call(this.frame_426).wait(1).call(this.frame_427).wait(31).call(this.frame_458).wait(1));

	// effect2
	this.instance = new lib.drop1_v2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-67.9,-548.55,1.1645,1.1645);
	this.instance._off = true;

	this.instance_1 = new lib.heart();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-78.6,-497.65,0.4532,0.4532);
	this.instance_1.alpha = 0;
	this.instance_1.compositeOperation = "lighter";
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(92).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-93.5,y:-557.55,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-105.15,y:-561.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false,rotation:0,x:-67.9,y:-548.55,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-93.5,y:-557.55,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-105.15,y:-561.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-67.9,y:-548.55,alpha:1},0).to({rotation:-44.9995,x:-105.15,y:-561.85,alpha:0.2188},1,cjs.Ease.get(1)).to({_off:true},2).wait(205).to({_off:false,rotation:0,x:-67.9,y:-548.55,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-93.5,y:-557.55,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-105.15,y:-561.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-67.9,y:-548.55,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-93.5,y:-557.55,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-105.15,y:-561.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-67.9,y:-548.55,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-93.5,y:-557.55,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-105.15,y:-561.85,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-67.9,y:-548.55,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-93.5,y:-557.55,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-105.15,y:-561.85,alpha:0.2188},0).to({_off:true},1).wait(133));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(364).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-80.35,y:-511.8,alpha:0.375},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-83.6,y:-517.65,alpha:0.5},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-81.05,y:-515.5,alpha:0.4444},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-80.5,y:-512.25,alpha:0.2778},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-81.6,y:-507.65,alpha:0},0).to({_off:true},1).wait(89));

	// effect
	this.instance_2 = new lib.spread_flower_pink("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-13.75,-454.4,1.4808,1.4808);

	this.instance_3 = new lib.good_effect("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(-13.75,-454.4,1.481,1.481);

	this.instance_4 = new lib.drop2_v2("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-69.7,-538.8,0.9876,0.9876,14.9998);
	this.instance_4._off = true;

	this.instance_5 = new lib.notice();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-85.45,-544.45,1.187,1.187,0,-169.8305,10.1695,-29.1,20.4);
	this.instance_5._off = true;

	this.instance_6 = new lib.laugh("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(-106.2,-539.05,1.4204,1.4204,35.8424,0,0,-30.2,20.6);
	this.instance_6._off = true;

	this.instance_7 = new lib.chord("synched",0,false);
	this.instance_7.parent = this;
	this.instance_7.setTransform(-78.55,-456.8,1.0029,1.0029,-61.4995,0,0,-23.4,76.9);

	this.instance_8 = new lib.question();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-79.2,-541.4,1.053,1.053,-28.4906);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.instance_9 = new lib.mc_exclamation("synched",0,false);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-81.45,-556.1,1.0929,1.0929,-29.9996,0,0,0,0.1);

	this.instance_10 = new lib.drop1a("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-75.95,-537.5,1,1,0,0,0,-0.5,0.2);
	this.instance_10._off = true;

	this.instance_11 = new lib.shock("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(-79.3,-542.45,1.3878,1.3878,-121.2396);

	this.instance_12 = new lib.sigh("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(-56.8,-388.05);
	this.instance_12.alpha = 0.6016;
	this.instance_12._off = true;

	this.instance_13 = new lib.heart("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(-78.6,-497.65,0.4532,0.4532);
	this.instance_13._off = true;

	this.instance_14 = new lib.angry("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(59.35,-517.75,0.5276,0.5276);
	this.instance_14._off = true;

	this.instance_15 = new lib.mc_punpun();
	this.instance_15.parent = this;
	this.instance_15.setTransform(-71.7,-566.9,1.1377,1.1377);

	this.instance_16 = new lib.concent_wrapper("synched",0,false);
	this.instance_16.parent = this;
	this.instance_16.setTransform(-14.15,-454.95,1.2136,1.2136,0,0,0,-0.6,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},37).to({state:[{t:this.instance_3}]},10).to({state:[]},10).to({state:[{t:this.instance_4}]},35).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},2).to({state:[{t:this.instance_5}]},25).to({state:[]},2).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},2).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},2).to({state:[]},2).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},2).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},15).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},20).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},2).to({state:[{t:this.instance_8}]},7).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_8}]},6).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},2).to({state:[{t:this.instance_8}]},2).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_10}]},16).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},9).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},24).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},11).to({state:[]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},11).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},2).to({state:[{t:this.instance_13}]},3).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},6).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},5).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[]},1).to({state:[{t:this.instance_15}]},2).to({state:[]},12).to({state:[{t:this.instance_16}]},17).wait(32));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(92).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-101.125,y:-534.1875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-111.6,y:-532.65,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,y:-538.5},0).to({_off:true},2).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-69.7,y:-538.8,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-101.125,y:-534.1875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-111.6,y:-532.65,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-69.7,y:-538.8,alpha:1},0).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-111.6,y:-538.5,alpha:0.2188},1,cjs.Ease.get(1)).to({_off:true},2).wait(205).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-69.7,y:-538.8,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-101.125,y:-534.1875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-111.6,y:-532.65,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-69.7,y:-538.8,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-101.125,y:-538.575,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-111.6,y:-538.5,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-69.7,y:-538.8,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-101.125,y:-534.1875,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-111.6,y:-532.65,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-69.7,y:-538.8,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-101.125,y:-538.575,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-111.6,y:-538.5,alpha:0.2188},0).to({_off:true},1).wait(133));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(131).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-85.05,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-85.45,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-85.05,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-85.45,alpha:0},0).to({_off:true},1).wait(302));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(158).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-108.85,y:-538.3,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.2,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-106.2,y:-539.05,alpha:0,startPosition:19},0).to({_off:true},1).wait(281));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(200).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:-86.15,y:-554.8,alpha:0.5556},0).wait(1).to({x:-90.25,y:-563.05,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-91.55,y:-566.1,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-91.3,y:-565.15},0).wait(1).to({x:-90.3,y:-563.3},0).wait(1).to({x:-88.6,y:-560.15},0).wait(1).to({regX:0,regY:0,x:-86.15,y:-556.1},0).to({x:-86.9,y:-557.45},2).wait(8).to({regX:-0.2,regY:0.2,x:-86.65,y:-556.55,alpha:0.9298},0).wait(1).to({x:-85.6,y:-554.6,alpha:0.692},0).wait(1).to({x:-84,y:-551.7,alpha:0.339},0).wait(1).to({x:-82.85,y:-549.55,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-82.4,y:-549.25,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:-79.65,y:-541},0).wait(1).to({regX:-0.2,regY:0.2,x:-86.6,y:-554.4,alpha:0.5556},0).wait(1).to({x:-90.7,y:-562.65,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-92,y:-565.7,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-91.75,y:-564.75},0).wait(1).to({x:-90.75,y:-562.9},0).wait(1).to({x:-89.05,y:-559.75},0).wait(1).to({regX:0,regY:0,x:-86.6,y:-555.7},0).to({x:-87.35,y:-557.05},2).wait(3).to({regX:-0.2,regY:0.2,x:-87.1,y:-556.15,alpha:0.9298},0).wait(1).to({x:-86.05,y:-554.2,alpha:0.692},0).wait(1).to({x:-84.45,y:-551.3,alpha:0.339},0).wait(1).to({x:-83.3,y:-549.15,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-82.85,y:-548.85,alpha:0},0).to({_off:true},1).wait(214));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(266).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:-74.95,y:-533.8},0).wait(1).to({y:-529.95},0).wait(1).to({y:-526.7},0).wait(1).to({y:-524.05},0).wait(1).to({y:-521.95},0).wait(1).to({y:-520.45},0).wait(1).to({y:-519.55},0).wait(1).to({regX:-0.5,regY:0.2,x:-75.95,y:-518.5},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:-74.95,y:-519.3,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:-75.95,y:-518.5,alpha:0},0).to({_off:true},1).wait(172));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(345).to({_off:false},0).wait(1).to({x:-57.8,y:-387.05,alpha:1},0).wait(1).to({regX:0.9,x:-57.9,y:-386.1,alpha:0.8965},0).wait(1).to({x:-59.25,y:-384.9,alpha:0.7636},0).wait(1).to({x:-60.85,y:-383.45,alpha:0.6048},0).wait(1).to({x:-62.65,y:-381.85,alpha:0.4229},0).wait(1).to({x:-64.65,y:-380,alpha:0.2205},0).wait(1).to({regX:0,x:-67.8,y:-378.05,alpha:0},0).to({_off:true},1).wait(106));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(364).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-80.35,y:-511.8},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-83.6,y:-517.65},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-81.05,y:-515.5},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-80.5,y:-512.25},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-81.6,y:-507.65},0).to({scaleX:1,scaleY:1,x:-82.6,y:-511.65},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:-80,y:-510.65,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:-81.6,y:-511.4,alpha:0.1016},0).to({_off:true},1).wait(82));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(383).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-521.5},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-522.75},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(63));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:30.2,regY:-332.2,x:30.2,y:-340.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-341.4},0).wait(1).to({y:-338.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-337.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-337.95},0).wait(1).to({y:-331},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-328.95},0).wait(1).to({y:-331.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-337.15},0).wait(1).to({y:-331.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-337.15},0).wait(1).to({y:-331.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-331.3},0).wait(1).to({y:-331.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-341.2},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-345.15},0).wait(1).to({y:-341.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-330.2},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-332.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-341.2},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-345.15},0).wait(1).to({y:-341.55},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-330.2},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-332.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:30.2,regY:-332.2,x:30.2,y:-331.6},0).wait(1).to({y:-329.2},0).wait(1).to({y:-326.85},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-326.85},0).wait(1).to({y:-329.2},0).wait(1).to({y:-331.6},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:30.2,regY:-332.2,x:30.2,y:-332.05},0).wait(1).to({y:-331.5},0).wait(1).to({y:-330.4},0).wait(1).to({y:-329.05},0).wait(1).to({y:-327.95},0).wait(1).to({y:-327.4},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-327.4},0).wait(1).to({y:-327.95},0).wait(1).to({y:-329.05},0).wait(1).to({y:-330.4},0).wait(1).to({y:-331.5},0).wait(1).to({y:-332.05},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-327.45},0).wait(1).to({y:-331},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-330},0).wait(1).to({y:-331.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:30.2,regY:-332.2,rotation:-0.1047,x:29.75,y:-331.8},0).wait(1).to({rotation:-0.5152,x:28.1,y:-330.1},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.977,x:26.3,y:-328.2},0).wait(1).to({regX:0,regY:0,rotation:-1.1036,x:2,y:5},0).wait(1).to({regX:30.2,regY:-332.2,rotation:-0.6681,x:27.95,y:-328.45},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.7447,x:34.9,y:-330.65},0).wait(1).to({regX:0,regY:0,rotation:1.2696,x:0,y:0},0).wait(1).to({regX:30.2,regY:-332.2,rotation:1.1069,x:36.7,y:-331.3},0).wait(1).to({rotation:0.4769,x:33.5,y:-330.55},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.6068,x:28,y:-329.15},0).wait(1).to({rotation:-1.3542,x:24.2,y:-328.1},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(1).to({regX:30.2,regY:-332.2,rotation:-1.4624,x:23.55,y:-328.1},0).wait(1).to({rotation:-1.121,x:25.1,y:-329.15},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:27.75,y:-330.8},0).wait(1).to({rotation:-0.1291,x:29.55,y:-331.95},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:30.2,regY:-332.2,rotation:-0.0253,x:30.05,y:-332.15},0).wait(1).to({rotation:-0.1129,x:29.65,y:-331.9},0).wait(1).to({rotation:-0.2845,x:28.9,y:-331.45},0).wait(1).to({rotation:-0.5565,x:27.7,y:-330.7},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:26.15,y:-329.75},0).wait(1).to({rotation:-1.2075,x:24.75,y:-328.9},0).wait(1).to({rotation:-1.4141,x:23.8,y:-328.25},0).wait(1).to({rotation:-1.5201,x:23.35,y:-327.95},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(1).to({regX:30.2,regY:-332.2,rotation:-1.5302,x:23.3,y:-327.95},0).wait(1).to({rotation:-1.461,x:23.6,y:-328.1},0).wait(1).to({rotation:-1.3276,x:24.2,y:-328.5},0).wait(1).to({rotation:-1.1146,x:25.15,y:-329.15},0).wait(1).to({rotation:-0.8266,x:26.45,y:-329.95},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.5189,x:27.85,y:-330.75},0).wait(1).to({rotation:-0.2693,x:28.95,y:-331.5},0).wait(1).to({rotation:-0.1079,x:29.7,y:-331.95},0).wait(1).to({rotation:-0.0243,x:30.05,y:-332.15},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:30.2,regY:-332.2,x:30.2,y:-337.75},0).wait(1).to({y:-339.65},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-339.55},0).wait(1).to({y:-337.45},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:30.2,regY:-332.2,x:30.2,y:-340.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-341.4},0).wait(1).to({y:-338.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:30.2,regY:-332.2,rotation:-0.0253,x:30.05,y:-332.1},0).wait(1).to({rotation:-0.1129,x:29.65,y:-331.6},0).wait(1).to({rotation:-0.2845,x:28.9,y:-330.7},0).wait(1).to({rotation:-0.5565,x:27.7,y:-329.25},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:26.15,y:-327.4},0).wait(1).to({rotation:-1.2075,x:24.75,y:-325.75},0).wait(1).to({rotation:-1.4141,x:23.8,y:-324.6},0).wait(1).to({rotation:-1.5201,x:23.35,y:-324.05},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:9},0).wait(1).to({regX:30.2,regY:-332.2,rotation:-1.5305,x:23.3,y:-324},0).wait(1).to({rotation:-1.4624,x:23.55,y:-324.35},0).wait(1).to({rotation:-1.3309,x:24.2,y:-325.05},0).wait(1).to({rotation:-1.121,x:25.1,y:-326.25},0).wait(1).to({rotation:-0.8372,x:26.4,y:-327.85},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:27.75,y:-329.45},0).wait(1).to({rotation:-0.2881,x:28.85,y:-330.8},0).wait(1).to({rotation:-0.1291,x:29.55,y:-331.65},0).wait(1).to({rotation:-0.0467,x:29.95,y:-332.1},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:30.2,regY:-332.2,rotation:-0.147,x:29.5,y:-331.85},0).wait(1).to({rotation:-0.7239,x:26.9,y:-330.25},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.3727,x:24,y:-328.35},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(18).to({regX:30.2,regY:-332.2,rotation:-1.4913,x:23.45,y:-328.05},0).wait(1).to({rotation:-1.2701,x:24.45,y:-328.7},0).wait(1).to({rotation:-0.8372,x:26.4,y:-329.95},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:28.5,y:-331.25},0).wait(1).to({rotation:-0.094,x:29.7,y:-332.05},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:30.2,regY:-332.2,rotation:-0.0894,x:29.8,y:-332},0).wait(1).to({rotation:-0.4358,x:28.25,y:-331},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.0316,x:25.5,y:-329.35},0).wait(1).to({rotation:-1.4426,x:23.7,y:-328.15},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(8).to({regX:30.2,regY:-332.2,rotation:-1.4913,x:23.45,y:-328.05},0).wait(1).to({rotation:-1.2701,x:24.45,y:-328.7},0).wait(1).to({rotation:-0.8372,x:26.4,y:-329.95},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:28.5,y:-331.25},0).wait(1).to({rotation:-0.094,x:29.7,y:-332.05},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-340.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-341.4},0).wait(1).to({y:-338.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:30.2,regY:-332.2,x:27.45,y:-324.45},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:30.2,regY:-332.2,x:30.2,y:-319.95},0).wait(1).to({y:-322.9},0).wait(1).to({y:-327.85},0).wait(1).to({y:-331.3},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-331.2},0).wait(1).to({y:-325.25},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:30.2,regY:-332.2,x:30.2,y:-324.4},0).wait(1).to({y:-328.7},0).wait(1).to({y:-333},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-332.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:30.2,regY:-332.2,x:30.2,y:-340.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-341.4},0).wait(1).to({y:-338.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:30.2,regY:-332.2,x:27.45,y:-324.45},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:30.2,regY:-332.2,x:30.2,y:-321.45},0).wait(1).to({y:-329.2},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-333.2},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-332.35},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-331.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:30.2,regY:-332.2,x:30.2,y:-331.6},0).wait(1).to({y:-329.2},0).wait(1).to({y:-326.85},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-326.8},0).wait(1).to({y:-327.1},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:30.2,regY:-332.2,x:30.2,y:-327.6},0).wait(1).to({y:-329.1},0).wait(1).to({y:-331.35},0).wait(1).to({y:-332.8},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-332.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-339.8},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-341.4},0).wait(1).to({y:-338.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:30.2,regY:-332.2,x:30.2,y:-339.7},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:30.2,regY:-332.2,x:30.2,y:-340.2},0).wait(1).to({y:-334.2},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:30.2,regY:-332.2,x:30.2,y:-327.55},0).wait(1).to({y:-328.75},0).wait(1).to({y:-330.7},0).wait(1).to({y:-331.9},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-337.15},0).wait(1).to({y:-331.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-337.15},0).wait(1).to({y:-331.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:30.2,regY:-332.2,x:30.2,y:-331.3},0).wait(1).to({y:-331.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:30.2,regY:-332.2,x:33.2,y:-328.8},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:30.2,regY:-332.2,x:29.35,y:-322.75},0).wait(1).to({x:30,y:-322.35},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:30.2,regY:-332.2,x:30.2,y:-322.9},0).wait(1).to({y:-325.35},0).wait(1).to({y:-329.05},0).wait(1).to({y:-331.55},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(33));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-550.3,-984,1075.1,1153.1);
...
// stage content:
(lib._444_4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:150,scene2:151,end2:263,scene3:264,end3:384,scene4:385,end4:496,scene5:497,end5:629,scene6:630,end6:756,scene7:757,end7:874});
	...
	this.frame_216 = function() {
		exportRoot._g.m3 = "嬉しくて､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 5);
	}
	this.frame_231 = function() {
		exportRoot._g.m3 = "嬉しくて､浮かれてたら､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 4);
	}
	...
	this.frame_287 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "あんまり高くないから､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 5);
	}
	this.frame_317 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "しないかな……";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 5);
	}
	this.frame_342 = function() {
		exportRoot._g.m3 = "しないかな……でも､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 4);
	}
	...
	this.frame_385 = function() {
		exportRoot._g.m1 = "(って､ﾌﾟﾛﾃﾞｭｰｻｰさん!? ";
		exportRoot._g.m2 = "";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
	...
	this.frame_518 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "と控えてたけど……";
		exportRoot._u.setText();
	}
	this.frame_559 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "止めてもらって､";
		exportRoot._u.setText();
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(12).call(this.frame_27).wait(44).call(this.frame_71).wait(20).call(this.frame_91).wait(27).call(this.frame_118).wait(6).call(this.frame_124).wait(26).call(this.frame_150).wait(1).call(this.frame_151).wait(15).call(this.frame_166).wait(23).call(this.frame_189).wait(27).call(this.frame_216).wait(15).call(this.frame_231).wait(12).call(this.frame_243).wait(20).call(this.frame_263).wait(1).call(this.frame_264).wait(23).call(this.frame_287).wait(30).call(this.frame_317).wait(25).call(this.frame_342).wait(11).call(this.frame_353).wait(31).call(this.frame_384).wait(1).call(this.frame_385).wait(24).call(this.frame_409).wait(28).call(this.frame_437).wait(14).call(this.frame_451).wait(15).call(this.frame_466).wait(30).call(this.frame_496).wait(1).call(this.frame_497).wait(21).call(this.frame_518).wait(41).call(this.frame_559).wait(34).call(this.frame_593).wait(36).call(this.frame_629).wait(1).call(this.frame_630).wait(14).call(this.frame_644).wait(16).call(this.frame_660).wait(35).call(this.frame_695).wait(39).call(this.frame_734).wait(22).call(this.frame_756).wait(1).call(this.frame_757).wait(16).call(this.frame_773).wait(19).call(this.frame_792).wait(41).call(this.frame_833).wait(10).call(this.frame_843).wait(31).call(this.frame_874).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(879));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(874).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(879));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(860));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(864));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(15).to({alpha:0.1016},0).to({_off:true},1).wait(863));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(793).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},833).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(833).to({_off:false},0).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.ranko_finish_blur).wait(833).to({_off:false},0).wait(1).to({regX:120,regY:155,x:120,y:155,alpha:0.8489},0).wait(1).to({alpha:0.8403},0).wait(1).to({alpha:0.8253},0).wait(1).to({alpha:0.8029},0).wait(1).to({alpha:0.7723},0).wait(1).to({alpha:0.7324},0).wait(1).to({alpha:0.6823},0).wait(1).to({alpha:0.6211},0).wait(1).to({alpha:0.5487},0).wait(1).to({alpha:0.4662},0).wait(1).to({alpha:0.3767},0).wait(1).to({alpha:0.2865},0).wait(1).to({alpha:0.2036},0).wait(1).to({alpha:0.1357},0).wait(1).to({alpha:0.0874},0).wait(1).to({alpha:0.0595},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0.0508},0).to({_off:true},1).wait(28));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(833).to({_off:false},0).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(821).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(757).to({_off:false},0).to({alpha:0},7).to({_off:true},1).wait(114));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11}]}).to({state:[]},15).wait(864));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(15).to({_off:false},0).wait(1).to({regX:1,x:121,y:310.2},0).wait(1).to({y:316.75},0).wait(1).to({y:327.35},0).wait(1).to({y:341.7},0).wait(1).to({y:359.2},0).wait(1).to({y:379.2},0).wait(1).to({y:400.85},0).wait(1).to({y:423.15},0).wait(1).to({y:445},0).wait(1).to({y:465.25},0).wait(1).to({y:482.7},0).wait(1).to({y:496.25},0).wait(1).to({y:504.95},0).wait(1).to({regX:0,x:120,y:508},0).to({_off:true},1).wait(121).to({_off:false},0).to({y:352.3},31,cjs.Ease.quadOut).to({_off:true},575).wait(122));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(630).to({_off:false},0).to({alpha:1},35).to({_off:true},92).wait(122));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(630).to({_off:false},0).to({alpha:0.4492},35).to({_off:true},92).wait(122));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(15).to({_off:false},0).wait(806).to({_off:true},12).wait(46));

	// ef 
	this.instance_16 = new lib.ef2();
	this.instance_16.parent = this;
	this.instance_16.setTransform(303.9,164.2,1,1,0,0,0,303.9,443.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(15).to({regX:0.6,regY:884.5,scaleX:1.0395,scaleY:1.0405,x:-186.2,y:738.75},0).wait(56).to({regX:0.7,regY:884.6,scaleX:0.4928,scaleY:0.4933,x:-25.3,y:393.15},53,cjs.Ease.quadInOut).wait(27).to({regY:884.5,scaleX:0.6358,scaleY:0.6364,x:-67.1,y:498.55},31,cjs.Ease.quadInOut).wait(82).to({scaleX:0.778,scaleY:0.7787,x:-109.35,y:583.75},78,cjs.Ease.quadInOut).wait(43).to({alpha:0},19,cjs.Ease.quadInOut).to({_off:true},1).wait(474));
	...
	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.1,regY:0.1,scaleX:1.3163,scaleY:1.3163,x:142.7,y:716.45},0).wait(56).to({regY:0.4,scaleX:0.6245,scaleY:0.6245,x:130.4,y:383.05},53,cjs.Ease.quadInOut).wait(27).to({regX:0,regY:0,scaleX:0.8058,scaleY:0.8058,x:133.75,y:485.4},31,cjs.Ease.quadInOut).wait(82).to({regY:0.1,scaleX:0.9861,scaleY:0.9861,x:136.35,y:567.7},78,cjs.Ease.quadInOut).wait(43).to({alpha:0},19,cjs.Ease.quadInOut).to({_off:true},1).wait(474));
	...
	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({regX:-0.1,scaleX:1.3163,scaleY:1.3163,x:-186.4,y:-181.6},0).wait(56).to({regY:-0.2,scaleX:0.6245,scaleY:0.6245,x:-25.7,y:-43.3},53,cjs.Ease.quadInOut).wait(27).to({regX:0,regY:0,scaleX:0.8058,scaleY:0.8058,x:-67.55,y:-64.3},31,cjs.Ease.quadInOut).wait(82).to({scaleX:0.9861,scaleY:0.9861,x:-109.95,y:-105.05},78,cjs.Ease.quadInOut).wait(43).to({alpha:0},19,cjs.Ease.quadInOut).to({_off:true},1).wait(474));

	// ef2
	this.instance_17 = new lib.ef2();
	this.instance_17.parent = this;
	this.instance_17.setTransform(-170.3,706.8,0.9852,0.9861,0,0,0,0.7,884.4);
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(361).to({_off:false},0).wait(24).to({regY:884.5,scaleX:1.0814,scaleY:1.0824,x:-198.35,y:764.55},0).to({y:749.55},19,cjs.Ease.quadInOut).wait(93).to({regX:0.6,regY:884.4,scaleX:0.6482,scaleY:0.6488,x:-71.3,y:513.4},62,cjs.Ease.quadInOut).wait(71).to({scaleX:0.8973,scaleY:0.8981,x:-144.1,y:653.75},65,cjs.Ease.quadInOut).wait(62).to({regX:0.5,regY:884.2,scaleX:0.4116,scaleY:0.412,x:-2.55,y:321.15},0).wait(64).to({_off:true},12).wait(46));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(140.9,686.35,1.2487,1.2487);
	this.ch2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(361).to({_off:false},0).wait(24).to({scaleX:1.3707,scaleY:1.3707,x:143.3,y:739},0).to({y:724},19,cjs.Ease.quadInOut).wait(93).to({regX:0.2,regY:0.1,scaleX:0.8215,scaleY:0.8215,x:133.8,y:500.15},62,cjs.Ease.quadInOut).wait(71).to({regX:0,regY:0,scaleX:1.1373,scaleY:1.1373,x:139.45,y:635.25},65,cjs.Ease.quadInOut).wait(62).to({regX:0.2,scaleX:0.5217,scaleY:0.5217,x:128.5,y:312.7},0).wait(64).to({_off:true},12).wait(46));

	// bg2
	this.bg2 = new lib.bg_zoom_half();
	this.bg2.name = "bg2";
	this.bg2.parent = this;
	this.bg2.setTransform(-171,-165.4,1.2487,1.2487);
	this.bg2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg2).wait(361).to({_off:false},0).wait(24).to({scaleX:1.3707,scaleY:1.3707,x:-199.1,y:-196},0).to({y:-211},19,cjs.Ease.quadInOut).wait(93).to({scaleX:0.8215,scaleY:0.8215,x:-71.55,y:-60.35},62,cjs.Ease.quadInOut).wait(71).to({regX:-0.1,scaleX:1.1373,scaleY:1.1373,x:-144.75,y:-140.55},65,cjs.Ease.quadInOut).wait(62).to({scaleX:0.5217,scaleY:0.5217,x:-1.95,y:-43.2},0).wait(64).to({_off:true},12).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},821).wait(58));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).wait(821).to({_off:true},12).wait(41).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-282,-720,902,1486.6);
// library properties:
lib.properties = {
	id: '_444_4',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg", id:"_444_4_bg"},
		{src:"images/ch_base.png", id:"_444_4_ch_base"},
		{src:"images/ch_face10.png", id:"_444_4_ch_face10"},
		{src:"images/ch_face11.png", id:"_444_4_ch_face11"},
		{src:"images/ch_face12.png", id:"_444_4_ch_face12"},
		{src:"images/ch_face2.png", id:"_444_4_ch_face2"},
		{src:"images/ch_face3.png", id:"_444_4_ch_face3"},
		{src:"images/ch_face4.png", id:"_444_4_ch_face4"},
		{src:"images/ch_face5.png", id:"_444_4_ch_face5"},
		{src:"images/ch_face6.png", id:"_444_4_ch_face6"},
		{src:"images/ch_face7.png", id:"_444_4_ch_face7"},
		{src:"images/ch_face8.png", id:"_444_4_ch_face8"},
		{src:"images/ch_face9.png", id:"_444_4_ch_face9"},
		{src:"images/ef01.png", id:"_444_4_ef01"},
		{src:"images/finish.jpg", id:"_444_4_finish"},
		{src:"images/finish_blur.jpg", id:"_444_4_finish_blur"},
		{src:"images/kirakira.png", id:"_444_4_kirakira"},
		{src:"images/tie_fp.png", id:"_444_4_tie_fp"},
		{src:"images/tie_sp.png", id:"_444_4_tie_sp"}
	],
	preloads: []
};
